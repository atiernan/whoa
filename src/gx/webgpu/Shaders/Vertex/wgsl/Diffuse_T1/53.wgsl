...
@vertex fn main(@location(0) vs_v0_: vec4<f32>, @location(1) vs_v1_: vec4<f32>, @location(2) @interpolate(flat) vs_v2_u: vec4<u32>, @location(3) vs_v3_: vec4<f32>, @location(6) vs_v4_: vec4<f32>) -> VertexOutput {
    ...
    let _e225 = normalize(vs_r0_.xyz);
    vs_r2_.x = _e225.x;
    vs_r2_.y = _e225.y;
    vs_r2_.z = _e225.z;
    vs_r1_.w = 1f;
    ...
    let _e280 = global.vs_uniforms_vec4_[10].xyz;
    vs_r3_.x = _e280.x;
    vs_r3_.y = _e280.y;
    vs_r3_.z = _e280.z;
    let _e298 = ((vs_r0_.xxx * vs_r3_.xyz) + global.vs_uniforms_vec4_[11].xyz);
    vs_r0_.x = _e298.x;
    vs_r0_.y = _e298.y;
    vs_r0_.z = _e298.z;
    let _e314 = (-(vs_r1_.xyz) + global.vs_uniforms_vec4_[21].xyz);
    vs_r3_.x = _e314.x;
    vs_r3_.y = _e314.y;
    vs_r3_.z = _e314.z;
    vs_r0_.w = dot(vs_r3_.xyz, vs_r2_.xyz);
    let _e330 = vs_r2_.xyz;
    vs_o4_.x = _e330.x;
    vs_o4_.y = _e330.y;
    vs_o4_.z = _e330.z;
    ...
    vs_r0_.w = (vs_r2_.x * vs_r0_.w);
    let _e435 = clamp(((global.vs_uniforms_vec4_[17].xyz * vs_r0_.www) + vs_r0_.xyz), vec3(0f), vec3(1f));
    vs_r0_.x = _e435.x;
    vs_r0_.y = _e435.y;
    vs_r0_.z = _e435.z;
    vs_r0_.w = 1f;
    ...
    let _e520 = ((vs_v4_.xyx * vec3<f32>(1f, 1f, 0f)) + vec3<f32>(0f, 0f, 1f));
    vs_r0_.x = _e520.x;
    vs_r0_.y = _e520.y;
    vs_r0_.z = _e520.z;
