...
@vertex fn main(@location(0) vs_v0_: vec4<f32>, @location(2) @interpolate(flat) vs_v1_u: vec4<u32>, @location(3) vs_v2_: vec4<f32>, @location(6) vs_v3_: vec4<f32>) -> VertexOutput {
    ...
    vs_r3_.z = local_2;
    let _e343 = (vs_r5_.xyz * vs_r3_.xyz);
    vs_r5_.x = _e343.x;
    vs_r5_.y = _e343.y;
    vs_r5_.z = _e343.z;
    let _e356 = (vs_r4_.xyz * vs_r3_.xyz);
    vs_r3_.x = _e356.x;
    vs_r3_.y = _e356.y;
    vs_r3_.z = _e356.z;
    let _e371 = (vs_r3_.xyz * global.vs_uniforms_vec4_[26].xyz);
    vs_r3_.x = _e371.x;
    vs_r3_.y = _e371.y;
    vs_r3_.z = _e371.z;
    let _e389 = ((vs_r4_.xyz * global.vs_uniforms_vec4_[27].xyz) + vs_r3_.xyz);
    vs_r3_.x = _e389.x;
    vs_r3_.y = _e389.y;
    vs_r3_.z = _e389.z;
    let _e404 = (vs_r3_.xyz + global.vs_uniforms_vec4_[25].xyz);
    vs_r3_.x = _e404.x;
    vs_r3_.y = _e404.y;
    vs_r3_.z = _e404.z;
    let _e421 = max(vs_r5_.xyz, vec3<f32>(0f, 0f, 0f));
    vs_r4_.x = _e421.x;
    vs_r4_.y = _e421.y;
    vs_r4_.z = _e421.z;
    if (vs_r3_.x == 0f) {
    ...
    vs_r5_.z = local_5;
    let _e467 = (vs_r4_.xyz * vs_r5_.xyz);
    vs_r3_.x = _e467.x;
    vs_r3_.y = _e467.y;
    vs_r3_.z = _e467.z;
    let _e485 = ((global.vs_uniforms_vec4_[17].xyz * vs_r3_.xxx) + vs_r2_.xyz);
    vs_r2_.x = _e485.x;
    vs_r2_.y = _e485.y;
    vs_r2_.z = _e485.z;
    let _e503 = ((global.vs_uniforms_vec4_[18].xyz * vs_r3_.yyy) + vs_r2_.xyz);
    vs_r2_.x = _e503.x;
    vs_r2_.y = _e503.y;
    vs_r2_.z = _e503.z;
    let _e526 = clamp(((global.vs_uniforms_vec4_[19].xyz * vs_r3_.zzz) + vs_r2_.xyz), vec3(0f), vec3(1f));
    vs_r1_.x = _e526.x;
    vs_r1_.y = _e526.y;
    vs_r1_.z = _e526.z;
    ...
    let _e605 = ((vs_v3_.xyx * vec3<f32>(1f, 1f, 0f)) + vec3<f32>(0f, 0f, 1f));
    vs_r1_.x = _e605.x;
    vs_r1_.y = _e605.y;
    vs_r1_.z = _e605.z;
