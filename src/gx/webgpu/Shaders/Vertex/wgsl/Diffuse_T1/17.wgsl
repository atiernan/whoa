...
@vertex fn main(@location(0) vs_v0_: vec4<f32>, @location(2) @interpolate(flat) vs_v1_u: vec4<u32>, @location(3) vs_v2_: vec4<f32>, @location(6) vs_v3_: vec4<f32>) -> VertexOutput {
    ...
    vs_r4_.y = _e192.y;
    vs_r4_.z = _e192.z;
    let _e208 = (-(vs_r0_.xyz) + global.vs_uniforms_vec4_[23].xyz);
    vs_r0_.x = _e208.x;
    vs_r0_.y = _e208.y;
    vs_r0_.w = _e208.z;
    ...
    let _e296 = global.vs_uniforms_vec4_[10].xyz;
    vs_r2_.x = _e296.x;
    vs_r2_.y = _e296.y;
    vs_r2_.z = _e296.z;
    let _e314 = ((vs_r0_.xxx * vs_r2_.xyz) + global.vs_uniforms_vec4_[11].xyz);
    vs_r0_.x = _e314.x;
    vs_r0_.y = _e314.y;
    vs_r0_.z = _e314.z;
    if (vs_r1_.x == 0f) {
    ...
    vs_r2_.z = local_2;
    let _e360 = (vs_r3_.xyz * vs_r2_.xyz);
    vs_r3_.x = _e360.x;
    vs_r3_.y = _e360.y;
    vs_r3_.z = _e360.z;
    let _e373 = (vs_r1_.xyz * vs_r2_.xyz);
    vs_r2_.x = _e373.x;
    vs_r2_.y = _e373.y;
    vs_r2_.z = _e373.z;
    let _e388 = (vs_r2_.xyz * global.vs_uniforms_vec4_[26].xyz);
    vs_r2_.x = _e388.x;
    vs_r2_.y = _e388.y;
    vs_r2_.z = _e388.z;
    let _e406 = ((vs_r1_.xyz * global.vs_uniforms_vec4_[27].xyz) + vs_r2_.xyz);
    vs_r1_.x = _e406.x;
    vs_r1_.y = _e406.y;
    vs_r1_.z = _e406.z;
    let _e421 = (vs_r1_.xyz + global.vs_uniforms_vec4_[25].xyz);
    vs_r1_.x = _e421.x;
    vs_r1_.y = _e421.y;
    vs_r1_.z = _e421.z;
    let _e438 = max(vs_r3_.xyz, vec3<f32>(0f, 0f, 0f));
    vs_r2_.x = _e438.x;
    vs_r2_.y = _e438.y;
    vs_r2_.z = _e438.z;
    if (vs_r1_.x == 0f) {
    ...
    vs_r3_.z = local_5;
    let _e484 = (vs_r2_.xyz * vs_r3_.xyz);
    vs_r1_.x = _e484.x;
    vs_r1_.y = _e484.y;
    vs_r1_.z = _e484.z;
    let _e502 = ((global.vs_uniforms_vec4_[17].xyz * vs_r1_.xxx) + vs_r0_.xyz);
    vs_r0_.x = _e502.x;
    vs_r0_.y = _e502.y;
    vs_r0_.z = _e502.z;
    let _e520 = ((global.vs_uniforms_vec4_[18].xyz * vs_r1_.yyy) + vs_r0_.xyz);
    vs_r0_.x = _e520.x;
    vs_r0_.y = _e520.y;
    vs_r0_.z = _e520.z;
    let _e543 = clamp(((global.vs_uniforms_vec4_[19].xyz * vs_r1_.zzz) + vs_r0_.xyz), vec3(0f), vec3(1f));
    vs_r0_.x = _e543.x;
    vs_r0_.y = _e543.y;
    vs_r0_.z = _e543.z;
    vs_r0_.w = 1f;
