...
@vertex fn main(@location(0) vs_v0_: vec4<f32>, @location(2) @interpolate(flat) vs_v1_u: vec4<u32>, @location(3) vs_v2_: vec4<f32>, @location(6) vs_v3_: vec4<f32>) -> VertexOutput {
    ...
    let _e159 = normalize(vs_r2_.xyz);
    vs_r3_.x = _e159.x;
    vs_r3_.y = _e159.y;
    vs_r3_.z = _e159.z;
    vs_r2_.x = clamp(dot(-(global.vs_uniforms_vec4_[12].xyz), vs_r3_.xyz), 0f, 1f);
    let _e183 = global.vs_uniforms_vec4_[10].xyz;
    vs_r4_.x = _e183.x;
    vs_r4_.y = _e183.y;
    vs_r4_.z = _e183.z;
    let _e201 = ((vs_r2_.xxx * vs_r4_.xyz) + global.vs_uniforms_vec4_[11].xyz);
    vs_r2_.x = _e201.x;
    vs_r2_.y = _e201.y;
    vs_r2_.z = _e201.z;
    let _e217 = (-(vs_r0_.xyz) + global.vs_uniforms_vec4_[21].xyz);
    vs_r4_.x = _e217.x;
    vs_r4_.y = _e217.y;
    vs_r4_.z = _e217.z;
    vs_r2_.w = dot(vs_r4_.xyz, vs_r3_.xyz);
    let _e233 = vs_r3_.xyz;
    vs_o4_.x = _e233.x;
    vs_o4_.y = _e233.y;
    vs_o4_.z = _e233.z;
    ...
    let _e338 = clamp(((global.vs_uniforms_vec4_[17].xyz * vs_r2_.www) + vs_r2_.xyz), vec3(0f), vec3(1f));
    vs_r1_.x = _e338.x;
    vs_r1_.y = _e338.y;
    vs_r1_.z = _e338.z;
    ...
    let _e417 = ((vs_v3_.xyx * vec3<f32>(1f, 1f, 0f)) + vec3<f32>(0f, 0f, 1f));
    vs_r1_.x = _e417.x;
    vs_r1_.y = _e417.y;
    vs_r1_.z = _e417.z;
