...
@vertex fn main(@location(0) vs_v0_: vec4<f32>, @location(1) vs_v1_: vec4<f32>, @location(2) @interpolate(flat) vs_v2_u: vec4<u32>, @location(3) vs_v3_: vec4<f32>, @location(6) vs_v4_: vec4<f32>) -> VertexOutput {
    ...
    let _e282 = global.vs_uniforms_vec4_[10].xyz;
    vs_r3_.x = _e282.x;
    vs_r3_.y = _e282.y;
    vs_r3_.z = _e282.z;
    let _e300 = ((vs_r0_.xxx * vs_r3_.xyz) + global.vs_uniforms_vec4_[11].xyz);
    vs_r0_.x = _e300.x;
    vs_r0_.y = _e300.y;
    vs_r0_.z = _e300.z;
    let _e316 = (-(vs_r1_.xyz) + global.vs_uniforms_vec4_[21].xyz);
    vs_r3_.x = _e316.x;
    vs_r3_.y = _e316.y;
    vs_r3_.z = _e316.z;
    vs_r4_.x = dot(vs_r3_.xyz, vs_r2_.xyz);
    vs_r3_.x = dot(vs_r3_.xyz, vs_r3_.xyz);
    let _e344 = (-(vs_r1_.xyz) + global.vs_uniforms_vec4_[22].xyz);
    vs_r5_.x = _e344.x;
    vs_r5_.y = _e344.y;
    vs_r5_.z = _e344.z;
    vs_r4_.y = dot(vs_r5_.xyz, vs_r2_.xyz);
    vs_r3_.y = dot(vs_r5_.xyz, vs_r5_.xyz);
    let _e366 = vs_r2_.xyz;
    vs_o4_.x = _e366.x;
    vs_o4_.y = _e366.y;
    vs_o4_.z = _e366.z;
    if (vs_r3_.x == 0f) {
    ...
    vs_r2_.y = local_1;
    let _e401 = (vs_r4_.xy * vs_r2_.xy);
    vs_r2_.z = _e401.x;
    vs_r2_.w = _e401.y;
    let _e412 = (vs_r3_.xy * vs_r2_.xy);
    vs_r2_.x = _e412.x;
    vs_r2_.y = _e412.y;
    let _e425 = (vs_r2_.xy * global.vs_uniforms_vec4_[26].xy);
    vs_r2_.x = _e425.x;
    vs_r2_.y = _e425.y;
    let _e441 = ((vs_r3_.xy * global.vs_uniforms_vec4_[27].xy) + vs_r2_.xy);
    vs_r2_.x = _e441.x;
    vs_r2_.y = _e441.y;
    let _e454 = (vs_r2_.xy + global.vs_uniforms_vec4_[25].xy);
    vs_r2_.x = _e454.x;
    vs_r2_.y = _e454.y;
    let _e469 = max(vs_r2_.zw, vec2<f32>(0f, 0f));
    vs_r2_.z = _e469.x;
    vs_r2_.w = _e469.y;
    if (vs_r2_.x == 0f) {
        local_2 = FLT_MAX;
    ...
    vs_r3_.y = local_3;
    let _e502 = (vs_r2_.zw * vs_r3_.xy);
    vs_r2_.x = _e502.x;
    vs_r2_.y = _e502.y;
    let _e518 = ((global.vs_uniforms_vec4_[17].xyz * vs_r2_.xxx) + vs_r0_.xyz);
    vs_r0_.x = _e518.x;
    vs_r0_.y = _e518.y;
    vs_r0_.z = _e518.z;
    let _e541 = clamp(((global.vs_uniforms_vec4_[18].xyz * vs_r2_.yyy) + vs_r0_.xyz), vec3(0f), vec3(1f));
    vs_r0_.x = _e541.x;
    vs_r0_.y = _e541.y;
    vs_r0_.z = _e541.z;
    vs_r0_.w = 1f;
    ...
    let _e626 = ((vs_v4_.xyx * vec3<f32>(1f, 1f, 0f)) + vec3<f32>(0f, 0f, 1f));
    vs_r0_.x = _e626.x;
    vs_r0_.y = _e626.y;
    vs_r0_.z = _e626.z;
