...
@vertex fn main(@location(0) vs_v0_: vec4<f32>, @location(2) @interpolate(flat) vs_v1_u: vec4<u32>, @location(3) vs_v2_: vec4<f32>, @location(6) vs_v3_: vec4<f32>) -> VertexOutput {
    ...
    vs_r4_.y = _e222.y;
    vs_r4_.z = _e222.z;
    let _e233 = normalize(vs_r0_.xyz);
    vs_r5_.x = _e233.x;
    vs_r5_.y = _e233.y;
    vs_r5_.z = _e233.z;
    ...
    vs_r0_.z = local_2;
    let _e331 = (vs_r3_.xyz * vs_r0_.xyz);
    vs_r3_.x = _e331.x;
    vs_r3_.y = _e331.y;
    vs_r3_.z = _e331.z;
    let _e344 = (vs_r1_.xyz * vs_r0_.xyz);
    vs_r0_.x = _e344.x;
    vs_r0_.y = _e344.y;
    vs_r0_.z = _e344.z;
    let _e359 = (vs_r0_.xyz * global.vs_uniforms_vec4_[26].xyz);
    vs_r0_.x = _e359.x;
    vs_r0_.y = _e359.y;
    vs_r0_.z = _e359.z;
    let _e377 = ((vs_r1_.xyz * global.vs_uniforms_vec4_[27].xyz) + vs_r0_.xyz);
    vs_r0_.x = _e377.x;
    vs_r0_.y = _e377.y;
    vs_r0_.z = _e377.z;
    let _e392 = (vs_r0_.xyz + global.vs_uniforms_vec4_[25].xyz);
    vs_r0_.x = _e392.x;
    vs_r0_.y = _e392.y;
    vs_r0_.z = _e392.z;
    let _e409 = max(vs_r3_.xyz, vec3<f32>(0f, 0f, 0f));
    vs_r1_.x = _e409.x;
    vs_r1_.y = _e409.y;
    vs_r1_.z = _e409.z;
    if (vs_r0_.x == 0f) {
    ...
    vs_r3_.z = local_5;
    let _e455 = (vs_r1_.xyz * vs_r3_.xyz);
    vs_r0_.x = _e455.x;
    vs_r0_.y = _e455.y;
    vs_r0_.z = _e455.z;
    vs_r0_.w = clamp(dot(-(global.vs_uniforms_vec4_[12].xyz), vs_r2_.xyz), 0f, 1f);
    let _e479 = global.vs_uniforms_vec4_[10].xyz;
    vs_r1_.x = _e479.x;
    vs_r1_.y = _e479.y;
    vs_r1_.z = _e479.z;
    let _e497 = ((vs_r0_.www * vs_r1_.xyz) + global.vs_uniforms_vec4_[11].xyz);
    vs_r1_.x = _e497.x;
    vs_r1_.y = _e497.y;
    vs_r1_.z = _e497.z;
    let _e515 = ((global.vs_uniforms_vec4_[17].xyz * vs_r0_.xxx) + vs_r1_.xyz);
    vs_r1_.x = _e515.x;
    vs_r1_.y = _e515.y;
    vs_r1_.z = _e515.z;
    let _e533 = ((global.vs_uniforms_vec4_[18].xyz * vs_r0_.yyy) + vs_r1_.xyz);
    vs_r0_.x = _e533.x;
    vs_r0_.y = _e533.y;
    vs_r0_.w = _e533.z;
    let _e556 = clamp(((global.vs_uniforms_vec4_[19].xyz * vs_r0_.zzz) + vs_r0_.xyw), vec3(0f), vec3(1f));
    vs_r0_.x = _e556.x;
    vs_r0_.y = _e556.y;
    vs_r0_.z = _e556.z;
    vs_r0_.w = 1f;
    ...
    let _e648 = ((vs_r0_.xxx * -(vs_r2_.xyz)) + -(vs_r5_.xyz));
    vs_r0_.x = _e648.x;
    vs_r0_.y = _e648.y;
    vs_r0_.z = _e648.z;
    ...
    vs_r0_.z = local_6;
    let _e687 = (vs_r0_.xy * vs_r0_.zz);
    vs_r0_.x = _e687.x;
    vs_r0_.y = _e687.y;
    let _e709 = ((vs_r0_.xy * vec2<f32>(0.5f, 0.5f)) + vec2<f32>(0.5f, 0.5f));
    vs_o3_.x = _e709.x;
    vs_o3_.y = _e709.y;
