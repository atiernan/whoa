...
@vertex fn main(@location(0) vs_v0_: vec4<f32>, @location(2) @interpolate(flat) vs_v1_u: vec4<u32>, @location(3) vs_v2_: vec4<f32>, @location(6) vs_v3_: vec4<f32>) -> VertexOutput {
    ...
    vs_r0_.y = local_1;
    let _e292 = (vs_r3_.xy * vs_r0_.xy);
    vs_r0_.z = _e292.x;
    vs_r0_.w = _e292.y;
    let _e303 = (vs_r1_.xy * vs_r0_.xy);
    vs_r0_.x = _e303.x;
    vs_r0_.y = _e303.y;
    let _e316 = (vs_r0_.xy * global.vs_uniforms_vec4_[26].xy);
    vs_r0_.x = _e316.x;
    vs_r0_.y = _e316.y;
    let _e332 = ((vs_r1_.xy * global.vs_uniforms_vec4_[27].xy) + vs_r0_.xy);
    vs_r0_.x = _e332.x;
    vs_r0_.y = _e332.y;
    let _e345 = (vs_r0_.xy + global.vs_uniforms_vec4_[25].xy);
    vs_r0_.x = _e345.x;
    vs_r0_.y = _e345.y;
    let _e360 = max(vs_r0_.zw, vec2<f32>(0f, 0f));
    vs_r0_.z = _e360.x;
    vs_r0_.w = _e360.y;
    if (vs_r0_.x == 0f) {
        local_2 = FLT_MAX;
    ...
    vs_r1_.y = local_3;
    let _e393 = (vs_r0_.zw * vs_r1_.xy);
    vs_r0_.x = _e393.x;
    vs_r0_.y = _e393.y;
    vs_r0_.z = clamp(dot(-(global.vs_uniforms_vec4_[12].xyz), vs_r2_.xyz), 0f, 1f);
    let _e415 = global.vs_uniforms_vec4_[10].xyz;
    vs_r1_.x = _e415.x;
    vs_r1_.y = _e415.y;
    vs_r1_.z = _e415.z;
    let _e433 = ((vs_r0_.zzz * vs_r1_.xyz) + global.vs_uniforms_vec4_[11].xyz);
    vs_r1_.x = _e433.x;
    vs_r1_.y = _e433.y;
    vs_r1_.z = _e433.z;
    let _e451 = ((global.vs_uniforms_vec4_[17].xyz * vs_r0_.xxx) + vs_r1_.xyz);
    vs_r0_.x = _e451.x;
    vs_r0_.z = _e451.y;
    vs_r0_.w = _e451.z;
    let _e474 = clamp(((global.vs_uniforms_vec4_[18].xyz * vs_r0_.yyy) + vs_r0_.xzw), vec3(0f), vec3(1f));
    vs_r0_.x = _e474.x;
    vs_r0_.y = _e474.y;
    vs_r0_.z = _e474.z;
    vs_r0_.w = 1f;
    ...
    let _e519 = ((vs_v3_.xyx * vec3<f32>(1f, 1f, 0f)) + vec3<f32>(0f, 0f, 1f));
    vs_r0_.x = _e519.x;
    vs_r0_.y = _e519.y;
    vs_r0_.z = _e519.z;
    ...
    let _e566 = ((vs_r0_.xxx * -(vs_r2_.xyz)) + -(vs_r5_.xyz));
    vs_r0_.x = _e566.x;
    vs_r0_.y = _e566.y;
    vs_r0_.z = _e566.z;
    ...
    vs_r0_.z = local_4;
    let _e605 = (vs_r0_.xy * vs_r0_.zz);
    vs_r0_.x = _e605.x;
    vs_r0_.y = _e605.y;
    let _e627 = ((vs_r0_.xy * vec2<f32>(0.5f, 0.5f)) + vec2<f32>(0.5f, 0.5f));
    vs_o3_.x = _e627.x;
    vs_o3_.y = _e627.y;
