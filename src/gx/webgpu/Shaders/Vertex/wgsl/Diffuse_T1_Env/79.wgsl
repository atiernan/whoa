...
@vertex fn main(@location(0) vs_v0_: vec4<f32>, @location(2) @interpolate(flat) vs_v1_u: vec4<u32>, @location(3) vs_v2_: vec4<f32>, @location(6) vs_v3_: vec4<f32>) -> VertexOutput {
    ...
    let _e304 = (-(vs_r0_.xyz) + global.vs_uniforms_vec4_[24].xyz);
    vs_r6_.x = _e304.x;
    vs_r6_.y = _e304.y;
    vs_r6_.z = _e304.z;
    ...
    let _e456 = ((global.vs_uniforms_vec4_[17].xyz * vs_r4_.xxx) + vs_r2_.xyz);
    vs_r2_.x = _e456.x;
    vs_r2_.y = _e456.y;
    vs_r2_.z = _e456.z;
    let _e474 = ((global.vs_uniforms_vec4_[18].xyz * vs_r4_.yyy) + vs_r2_.xyz);
    vs_r2_.x = _e474.x;
    vs_r2_.y = _e474.y;
    vs_r2_.z = _e474.z;
    let _e492 = ((global.vs_uniforms_vec4_[19].xyz * vs_r4_.zzz) + vs_r2_.xyz);
    vs_r2_.x = _e492.x;
    vs_r2_.y = _e492.y;
    vs_r2_.z = _e492.z;
    let _e515 = clamp(((global.vs_uniforms_vec4_[20].xyz * vs_r4_.www) + vs_r2_.xyz), vec3(0f), vec3(1f));
    vs_r1_.x = _e515.x;
    vs_r1_.y = _e515.y;
    vs_r1_.z = _e515.z;
    ...
    vs_r1_.z = local_8;
    let _e701 = (vs_r1_.xy * vs_r1_.zz);
    vs_r1_.x = _e701.x;
    vs_r1_.y = _e701.y;
    let _e723 = ((vs_r1_.xy * vec2<f32>(0.5f, 0.5f)) + vec2<f32>(0.5f, 0.5f));
    vs_o3_.x = _e723.x;
    vs_o3_.y = _e723.y;
