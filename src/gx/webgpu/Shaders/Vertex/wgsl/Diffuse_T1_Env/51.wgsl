...
@vertex fn main(@location(0) vs_v0_: vec4<f32>, @location(1) vs_v1_: vec4<f32>, @location(2) @interpolate(flat) vs_v2_u: vec4<u32>, @location(3) vs_v3_: vec4<f32>, @location(6) vs_v4_: vec4<f32>) -> VertexOutput {
    ...
    vs_r3_.y = _e281.y;
    vs_r3_.z = _e281.z;
    let _e304 = clamp(((vs_r0_.xxx * vs_r3_.xyz) + global.vs_uniforms_vec4_[11].xyz), vec3(0f), vec3(1f));
    vs_r0_.x = _e304.x;
    vs_r0_.y = _e304.y;
    vs_r0_.z = _e304.z;
    vs_r0_.w = 1f;
    ...
    vs_r0_.z = local;
    let _e496 = (vs_r0_.xy * vs_r0_.zz);
    vs_r0_.x = _e496.x;
    vs_r0_.y = _e496.y;
    let _e518 = ((vs_r0_.xy * vec2<f32>(0.5f, 0.5f)) + vec2<f32>(0.5f, 0.5f));
    vs_o3_.x = _e518.x;
    vs_o3_.y = _e518.y;
