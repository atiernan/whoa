...
@vertex fn main(@location(0) vs_v0_: vec4<f32>, @location(2) @interpolate(flat) vs_v1_u: vec4<u32>, @location(3) vs_v2_: vec4<f32>, @location(6) vs_v3_: vec4<f32>) -> VertexOutput {
    ...
    let _e109 = normalize(vs_r0_.xyz);
    vs_r1_.x = _e109.x;
    vs_r1_.y = _e109.y;
    vs_r1_.z = _e109.z;
    ...
    let _e199 = normalize(vs_r0_.xyz);
    vs_r2_.x = _e199.x;
    vs_r2_.y = _e199.y;
    vs_r2_.z = _e199.z;
    vs_r0_.x = clamp(dot(-(global.vs_uniforms_vec4_[12].xyz), vs_r2_.xyz), 0f, 1f);
    let _e223 = global.vs_uniforms_vec4_[10].xyz;
    vs_r3_.x = _e223.x;
    vs_r3_.y = _e223.y;
    vs_r3_.z = _e223.z;
    let _e246 = clamp(((vs_r0_.xxx * vs_r3_.xyz) + global.vs_uniforms_vec4_[11].xyz), vec3(0f), vec3(1f));
    vs_r0_.x = _e246.x;
    vs_r0_.y = _e246.y;
    vs_r0_.z = _e246.z;
    vs_r0_.w = 1f;
    ...
    let _e291 = ((vs_v3_.xyx * vec3<f32>(1f, 1f, 0f)) + vec3<f32>(0f, 0f, 1f));
    vs_r0_.x = _e291.x;
    vs_r0_.y = _e291.y;
    vs_r0_.z = _e291.z;
    ...
    let _e338 = ((vs_r0_.xxx * -(vs_r2_.xyz)) + -(vs_r1_.xyz));
    vs_r0_.x = _e338.x;
    vs_r0_.y = _e338.y;
    vs_r0_.z = _e338.z;
    ...
    vs_r0_.z = local;
    let _e377 = (vs_r0_.xy * vs_r0_.zz);
    vs_r0_.x = _e377.x;
    vs_r0_.y = _e377.y;
    let _e399 = ((vs_r0_.xy * vec2<f32>(0.5f, 0.5f)) + vec2<f32>(0.5f, 0.5f));
    vs_o3_.x = _e399.x;
    vs_o3_.y = _e399.y;
