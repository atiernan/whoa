...
@vertex fn main(@location(0) vs_v0_: vec4<f32>, @location(3) vs_v1_: vec4<f32>, @location(6) vs_v2_: vec4<f32>) -> VertexOutput {
    ...
    vs_r4_.y = _e128.y;
    vs_r4_.z = _e128.z;
    let _e151 = clamp(((vs_r2_.xxx * vs_r4_.xyz) + global.vs_uniforms_vec4_[11].xyz), vec3(0f), vec3(1f));
    vs_r1_.x = _e151.x;
    vs_r1_.y = _e151.y;
    vs_r1_.z = _e151.z;
    ...
    vs_r1_.z = local;
    let _e337 = (vs_r1_.xy * vs_r1_.zz);
    vs_r1_.x = _e337.x;
    vs_r1_.y = _e337.y;
    let _e359 = ((vs_r1_.xy * vec2<f32>(0.5f, 0.5f)) + vec2<f32>(0.5f, 0.5f));
    vs_o3_.x = _e359.x;
    vs_o3_.y = _e359.y;
