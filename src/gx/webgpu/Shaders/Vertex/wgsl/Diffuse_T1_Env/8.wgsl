...
@vertex fn main(@location(0) vs_v0_: vec4<f32>, @location(3) vs_v1_: vec4<f32>, @location(6) vs_v2_: vec4<f32>) -> VertexOutput {
    ...
    let _e144 = ((vs_v2_.xyx * vec3<f32>(1f, 1f, 0f)) + vec3<f32>(0f, 0f, 1f));
    vs_r0_.x = _e144.x;
    vs_r0_.y = _e144.y;
    vs_r0_.z = _e144.z;
    ...
    let _e195 = normalize(vs_r0_.xyz);
    vs_r2_.x = _e195.x;
    vs_r2_.y = _e195.y;
    vs_r2_.z = _e195.z;
    vs_r0_.x = dot(-(vs_r1_.xyz), vs_r2_.xyz);
    vs_r0_.x = (vs_r0_.x + vs_r0_.x);
    let _e226 = ((vs_r0_.xxx * -(vs_r2_.xyz)) + -(vs_r1_.xyz));
    vs_r0_.x = _e226.x;
    vs_r0_.y = _e226.y;
    vs_r0_.z = _e226.z;
    ...
    vs_r0_.z = local;
    let _e265 = (vs_r0_.xy * vs_r0_.zz);
    vs_r0_.x = _e265.x;
    vs_r0_.y = _e265.y;
    let _e287 = ((vs_r0_.xy * vec2<f32>(0.5f, 0.5f)) + vec2<f32>(0.5f, 0.5f));
    vs_o3_.x = _e287.x;
    vs_o3_.y = _e287.y;
