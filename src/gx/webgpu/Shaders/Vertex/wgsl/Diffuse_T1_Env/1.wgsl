...
@vertex fn main(@location(0) vs_v0_: vec4<f32>, @location(3) vs_v1_: vec4<f32>, @location(6) vs_v2_: vec4<f32>) -> VertexOutput {
    ...
    let _e143 = normalize(vs_r0_.xyz);
    vs_r2_.x = _e143.x;
    vs_r2_.y = _e143.y;
    vs_r2_.z = _e143.z;
    vs_r0_.x = clamp(dot(-(global.vs_uniforms_vec4_[12].xyz), vs_r2_.xyz), 0f, 1f);
    let _e167 = global.vs_uniforms_vec4_[10].xyz;
    vs_r3_.x = _e167.x;
    vs_r3_.y = _e167.y;
    vs_r3_.z = _e167.z;
    let _e190 = clamp(((vs_r0_.xxx * vs_r3_.xyz) + global.vs_uniforms_vec4_[11].xyz), vec3(0f), vec3(1f));
    vs_r0_.x = _e190.x;
    vs_r0_.y = _e190.y;
    vs_r0_.z = _e190.z;
    vs_r0_.w = 1f;
    ...
    let _e235 = ((vs_v2_.xyx * vec3<f32>(1f, 1f, 0f)) + vec3<f32>(0f, 0f, 1f));
    vs_r0_.x = _e235.x;
    vs_r0_.y = _e235.y;
    vs_r0_.z = _e235.z;
