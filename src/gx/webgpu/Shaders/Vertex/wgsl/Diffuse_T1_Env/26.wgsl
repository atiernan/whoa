...
@vertex fn main(@location(0) vs_v0_: vec4<f32>, @location(1) vs_v1_: vec4<f32>, @location(2) @interpolate(flat) vs_v2_u: vec4<u32>, @location(3) vs_v3_: vec4<f32>, @location(6) vs_v4_: vec4<f32>) -> VertexOutput {
    ...
    let _e264 = normalize(vs_r1_.xyz);
    vs_r0_.x = _e264.x;
    vs_r0_.y = _e264.y;
    vs_r0_.z = _e264.z;
    ...
    let _e341 = ((vs_v4_.xyx * vec3<f32>(1f, 1f, 0f)) + vec3<f32>(0f, 0f, 1f));
    vs_r1_.x = _e341.x;
    vs_r1_.y = _e341.y;
    vs_r1_.z = _e341.z;
    ...
    let _e388 = ((vs_r0_.www * -(vs_r2_.xyz)) + -(vs_r0_.xyz));
    vs_r0_.x = _e388.x;
    vs_r0_.y = _e388.y;
    vs_r0_.z = _e388.z;
    ...
    vs_r0_.z = local;
    let _e427 = (vs_r0_.xy * vs_r0_.zz);
    vs_r0_.x = _e427.x;
    vs_r0_.y = _e427.y;
    let _e449 = ((vs_r0_.xy * vec2<f32>(0.5f, 0.5f)) + vec2<f32>(0.5f, 0.5f));
    vs_o3_.x = _e449.x;
    vs_o3_.y = _e449.y;
