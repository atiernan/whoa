...
@vertex fn main(@location(0) vs_v0_: vec4<f32>, @location(3) vs_v1_: vec4<f32>, @location(6) vs_v2_: vec4<f32>) -> VertexOutput {
    ...
    let _e104 = normalize(vs_r2_.xyz);
    vs_r3_.x = _e104.x;
    vs_r3_.y = _e104.y;
    vs_r3_.z = _e104.z;
    vs_r2_.x = clamp(dot(-(global.vs_uniforms_vec4_[12].xyz), vs_r3_.xyz), 0f, 1f);
    let _e128 = global.vs_uniforms_vec4_[10].xyz;
    vs_r4_.x = _e128.x;
    vs_r4_.y = _e128.y;
    vs_r4_.z = _e128.z;
    let _e146 = ((vs_r2_.xxx * vs_r4_.xyz) + global.vs_uniforms_vec4_[11].xyz);
    vs_r2_.x = _e146.x;
    vs_r2_.y = _e146.y;
    vs_r2_.z = _e146.z;
    let _e162 = (-(vs_r0_.xyz) + global.vs_uniforms_vec4_[21].xyz);
    vs_r4_.x = _e162.x;
    vs_r4_.y = _e162.y;
    vs_r4_.z = _e162.z;
    ...
    let _e273 = clamp(((global.vs_uniforms_vec4_[17].xyz * vs_r2_.www) + vs_r2_.xyz), vec3(0f), vec3(1f));
    vs_r1_.x = _e273.x;
    vs_r1_.y = _e273.y;
    vs_r1_.z = _e273.z;
    ...
    vs_r1_.z = local_2;
    let _e459 = (vs_r1_.xy * vs_r1_.zz);
    vs_r1_.x = _e459.x;
    vs_r1_.y = _e459.y;
    let _e481 = ((vs_r1_.xy * vec2<f32>(0.5f, 0.5f)) + vec2<f32>(0.5f, 0.5f));
    vs_o3_.x = _e481.x;
    vs_o3_.y = _e481.y;
