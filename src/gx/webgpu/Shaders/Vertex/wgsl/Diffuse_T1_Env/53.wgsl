...
@vertex fn main(@location(0) vs_v0_: vec4<f32>, @location(1) vs_v1_: vec4<f32>, @location(2) @interpolate(flat) vs_v2_u: vec4<u32>, @location(3) vs_v3_: vec4<f32>, @location(6) vs_v4_: vec4<f32>) -> VertexOutput {
    ...
    let _e281 = global.vs_uniforms_vec4_[10].xyz;
    vs_r3_.x = _e281.x;
    vs_r3_.y = _e281.y;
    vs_r3_.z = _e281.z;
    let _e299 = ((vs_r0_.xxx * vs_r3_.xyz) + global.vs_uniforms_vec4_[11].xyz);
    vs_r0_.x = _e299.x;
    vs_r0_.y = _e299.y;
    vs_r0_.z = _e299.z;
    let _e315 = (-(vs_r1_.xyz) + global.vs_uniforms_vec4_[21].xyz);
    vs_r3_.x = _e315.x;
    vs_r3_.y = _e315.y;
    vs_r3_.z = _e315.z;
    vs_r0_.w = dot(vs_r3_.xyz, vs_r3_.xyz);
    vs_r2_.w = dot(vs_r3_.xyz, vs_r2_.xyz);
    if (vs_r0_.w == 0f) {
        local = FLT_MAX;
    } else {
    ...
    vs_r3_.x = local;
    vs_r3_.y = (vs_r0_.w * vs_r3_.x);
    vs_r2_.w = (vs_r2_.w * vs_r3_.x);
    vs_r2_.w = max(vs_r2_.w, 0f);
    vs_r3_.x = (vs_r3_.y * global.vs_uniforms_vec4_[26].x);
    vs_r0_.w = ((vs_r0_.w * global.vs_uniforms_vec4_[27].x) + vs_r3_.x);
    vs_r0_.w = (vs_r0_.w + global.vs_uniforms_vec4_[25].x);
    if (vs_r0_.w == 0f) {
        local_1 = FLT_MAX;
    } else {
        local_1 = (1f / vs_r0_.w);
    ...
    vs_r0_.w = local_1;
    vs_r0_.w = (vs_r2_.w * vs_r0_.w);
    let _e426 = clamp(((global.vs_uniforms_vec4_[17].xyz * vs_r0_.www) + vs_r0_.xyz), vec3(0f), vec3(1f));
    vs_r0_.x = _e426.x;
    vs_r0_.y = _e426.y;
    vs_r0_.z = _e426.z;
    vs_r0_.w = 1f;
    ...
    vs_r0_.z = local_2;
    let _e618 = (vs_r0_.xy * vs_r0_.zz);
    vs_r0_.x = _e618.x;
    vs_r0_.y = _e618.y;
    let _e640 = ((vs_r0_.xy * vec2<f32>(0.5f, 0.5f)) + vec2<f32>(0.5f, 0.5f));
    vs_o3_.x = _e640.x;
    vs_o3_.y = _e640.y;
