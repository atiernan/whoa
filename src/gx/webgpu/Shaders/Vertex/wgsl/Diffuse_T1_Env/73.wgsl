...
@vertex fn main(@location(0) vs_v0_: vec4<f32>, @location(2) @interpolate(flat) vs_v1_u: vec4<u32>, @location(3) vs_v2_: vec4<f32>, @location(6) vs_v3_: vec4<f32>) -> VertexOutput {
    ...
    let _e160 = normalize(vs_r2_.xyz);
    vs_r3_.x = _e160.x;
    vs_r3_.y = _e160.y;
    vs_r3_.z = _e160.z;
    vs_r2_.x = clamp(dot(-(global.vs_uniforms_vec4_[12].xyz), vs_r3_.xyz), 0f, 1f);
    let _e184 = global.vs_uniforms_vec4_[10].xyz;
    vs_r4_.x = _e184.x;
    vs_r4_.y = _e184.y;
    vs_r4_.z = _e184.z;
    let _e202 = ((vs_r2_.xxx * vs_r4_.xyz) + global.vs_uniforms_vec4_[11].xyz);
    vs_r2_.x = _e202.x;
    vs_r2_.y = _e202.y;
    vs_r2_.z = _e202.z;
    let _e218 = (-(vs_r0_.xyz) + global.vs_uniforms_vec4_[21].xyz);
    vs_r4_.x = _e218.x;
    vs_r4_.y = _e218.y;
    vs_r4_.z = _e218.z;
    ...
    let _e329 = clamp(((global.vs_uniforms_vec4_[17].xyz * vs_r2_.www) + vs_r2_.xyz), vec3(0f), vec3(1f));
    vs_r1_.x = _e329.x;
    vs_r1_.y = _e329.y;
    vs_r1_.z = _e329.z;
    ...
    vs_r1_.z = local_2;
    let _e515 = (vs_r1_.xy * vs_r1_.zz);
    vs_r1_.x = _e515.x;
    vs_r1_.y = _e515.y;
    let _e537 = ((vs_r1_.xy * vec2<f32>(0.5f, 0.5f)) + vec2<f32>(0.5f, 0.5f));
    vs_o3_.x = _e537.x;
    vs_o3_.y = _e537.y;
