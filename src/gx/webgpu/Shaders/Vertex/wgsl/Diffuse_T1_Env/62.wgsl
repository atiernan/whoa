...
@vertex fn main(@location(0) vs_v0_: vec4<f32>, @location(3) vs_v1_: vec4<f32>, @location(6) vs_v2_: vec4<f32>) -> VertexOutput {
    ...
    let _e138 = ((vs_v2_.xyx * vec3<f32>(1f, 1f, 0f)) + vec3<f32>(0f, 0f, 1f));
    vs_r1_.x = _e138.x;
    vs_r1_.y = _e138.y;
    vs_r1_.z = _e138.z;
    ...
    let _e189 = normalize(vs_r1_.xyz);
    vs_r2_.x = _e189.x;
    vs_r2_.y = _e189.y;
    vs_r2_.z = _e189.z;
    let _e200 = normalize(vs_r0_.xyz);
    vs_r1_.x = _e200.x;
    vs_r1_.y = _e200.y;
    vs_r1_.z = _e200.z;
    vs_r1_.w = dot(-(vs_r1_.xyz), vs_r2_.xyz);
    vs_r1_.w = (vs_r1_.w + vs_r1_.w);
    let _e231 = ((vs_r1_.www * -(vs_r2_.xyz)) + -(vs_r1_.xyz));
    vs_r1_.x = _e231.x;
    vs_r1_.y = _e231.y;
    vs_r1_.z = _e231.z;
    let _e241 = vs_r2_.xyz;
    vs_o5_.x = _e241.x;
    vs_o5_.y = _e241.y;
    vs_o5_.z = _e241.z;
    ...
    vs_r1_.z = local;
    let _e280 = (vs_r1_.xy * vs_r1_.zz);
    vs_r1_.x = _e280.x;
    vs_r1_.y = _e280.y;
    let _e302 = ((vs_r1_.xy * vec2<f32>(0.5f, 0.5f)) + vec2<f32>(0.5f, 0.5f));
    vs_o3_.x = _e302.x;
    vs_o3_.y = _e302.y;
