...
@vertex fn main(@location(0) vs_v0_: vec4<f32>, @location(2) @interpolate(flat) vs_v1_u: vec4<u32>, @location(3) vs_v2_: vec4<f32>, @location(6) vs_v3_: vec4<f32>) -> VertexOutput {
    ...
    let _e250 = (-(vs_r0_.xyz) + global.vs_uniforms_vec4_[24].xyz);
    vs_r4_.x = _e250.x;
    vs_r4_.y = _e250.y;
    vs_r4_.z = _e250.z;
    let _e261 = normalize(vs_r0_.xyz);
    vs_r5_.x = _e261.x;
    vs_r5_.y = _e261.y;
    vs_r5_.z = _e261.z;
    ...
    let _e459 = global.vs_uniforms_vec4_[10].xyz;
    vs_r3_.x = _e459.x;
    vs_r3_.y = _e459.y;
    vs_r3_.z = _e459.z;
    let _e477 = ((vs_r1_.xxx * vs_r3_.xyz) + global.vs_uniforms_vec4_[11].xyz);
    vs_r1_.x = _e477.x;
    vs_r1_.y = _e477.y;
    vs_r1_.z = _e477.z;
    let _e495 = ((global.vs_uniforms_vec4_[17].xyz * vs_r0_.xxx) + vs_r1_.xyz);
    vs_r1_.x = _e495.x;
    vs_r1_.y = _e495.y;
    vs_r1_.z = _e495.z;
    let _e513 = ((global.vs_uniforms_vec4_[18].xyz * vs_r0_.yyy) + vs_r1_.xyz);
    vs_r1_.x = _e513.x;
    vs_r1_.y = _e513.y;
    vs_r1_.z = _e513.z;
    let _e531 = ((global.vs_uniforms_vec4_[19].xyz * vs_r0_.zzz) + vs_r1_.xyz);
    vs_r0_.x = _e531.x;
    vs_r0_.y = _e531.y;
    vs_r0_.z = _e531.z;
    let _e554 = clamp(((global.vs_uniforms_vec4_[20].xyz * vs_r0_.www) + vs_r0_.xyz), vec3(0f), vec3(1f));
    vs_r0_.x = _e554.x;
    vs_r0_.y = _e554.y;
    vs_r0_.z = _e554.z;
    vs_r0_.w = 1f;
    ...
    let _e646 = ((vs_r0_.xxx * -(vs_r2_.xyz)) + -(vs_r5_.xyz));
    vs_r0_.x = _e646.x;
    vs_r0_.y = _e646.y;
    vs_r0_.z = _e646.z;
    ...
    vs_r0_.z = local_8;
    let _e685 = (vs_r0_.xy * vs_r0_.zz);
    vs_r0_.x = _e685.x;
    vs_r0_.y = _e685.y;
    let _e707 = ((vs_r0_.xy * vec2<f32>(0.5f, 0.5f)) + vec2<f32>(0.5f, 0.5f));
    vs_o3_.x = _e707.x;
    vs_o3_.y = _e707.y;
