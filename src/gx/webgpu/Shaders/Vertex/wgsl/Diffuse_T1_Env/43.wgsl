...
@vertex fn main(@location(0) vs_v0_: vec4<f32>, @location(2) @interpolate(flat) vs_v1_u: vec4<u32>, @location(3) vs_v2_: vec4<f32>, @location(6) vs_v3_: vec4<f32>) -> VertexOutput {
    ...
    let _e158 = normalize(vs_r2_.xyz);
    vs_r3_.x = _e158.x;
    vs_r3_.y = _e158.y;
    vs_r3_.z = _e158.z;
    vs_r2_.x = clamp(dot(-(global.vs_uniforms_vec4_[12].xyz), vs_r3_.xyz), 0f, 1f);
    let _e182 = global.vs_uniforms_vec4_[10].xyz;
    vs_r4_.x = _e182.x;
    vs_r4_.y = _e182.y;
    vs_r4_.z = _e182.z;
    let _e200 = ((vs_r2_.xxx * vs_r4_.xyz) + global.vs_uniforms_vec4_[11].xyz);
    vs_r2_.x = _e200.x;
    vs_r2_.y = _e200.y;
    vs_r2_.z = _e200.z;
    let _e216 = (-(vs_r0_.xyz) + global.vs_uniforms_vec4_[21].xyz);
    vs_r4_.x = _e216.x;
    vs_r4_.y = _e216.y;
    vs_r4_.z = _e216.z;
    ...
    let _e327 = clamp(((global.vs_uniforms_vec4_[17].xyz * vs_r2_.www) + vs_r2_.xyz), vec3(0f), vec3(1f));
    vs_r1_.x = _e327.x;
    vs_r1_.y = _e327.y;
    vs_r1_.z = _e327.z;
    ...
    vs_r1_.z = local_2;
    let _e513 = (vs_r1_.xy * vs_r1_.zz);
    vs_r1_.x = _e513.x;
    vs_r1_.y = _e513.y;
    let _e535 = ((vs_r1_.xy * vec2<f32>(0.5f, 0.5f)) + vec2<f32>(0.5f, 0.5f));
    vs_o3_.x = _e535.x;
    vs_o3_.y = _e535.y;
