...
@vertex fn main(@location(0) vs_v0_: vec4<f32>, @location(6) vs_v1_: vec4<f32>, @location(7) vs_v2_: vec4<f32>) -> VertexOutput {
    var vs_r0_: vec4<f32>;
    var vs_r1_: vec4<f32>;
    var vs_o1_: vec4<f32>;
    var vs_o2_: vec4<f32>;
    ...
    let _e131 = ((vs_v1_.xyx * vec3<f32>(1f, 1f, 0f)) + vec3<f32>(0f, 0f, 1f));
    vs_r0_.x = _e131.x;
    vs_r0_.y = _e131.y;
    vs_r0_.z = _e131.z;
    vs_o2_.x = dot(global.vs_uniforms_vec4_[6].xyw, vs_r0_.xyz);
    vs_o2_.y = dot(global.vs_uniforms_vec4_[7].xyw, vs_r0_.xyz);
    let _e171 = ((vs_v2_.xyx * vec3<f32>(1f, 1f, 0f)) + vec3<f32>(0f, 0f, 1f));
    vs_r0_.x = _e171.x;
    vs_r0_.y = _e171.y;
    vs_r0_.z = _e171.z;
