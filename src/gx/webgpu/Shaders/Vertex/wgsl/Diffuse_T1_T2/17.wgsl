...
@vertex fn main(@location(0) vs_v0_: vec4<f32>, @location(2) @interpolate(flat) vs_v1_u: vec4<u32>, @location(3) vs_v2_: vec4<f32>, @location(6) vs_v3_: vec4<f32>, @location(7) vs_v4_: vec4<f32>) -> VertexOutput {
    ...
    vs_r4_.y = _e194.y;
    vs_r4_.z = _e194.z;
    let _e210 = (-(vs_r0_.xyz) + global.vs_uniforms_vec4_[23].xyz);
    vs_r0_.x = _e210.x;
    vs_r0_.y = _e210.y;
    vs_r0_.w = _e210.z;
    ...
    vs_r3_.z = dot(vs_r0_.xyw, vs_r2_.xyz);
    vs_r1_.z = dot(vs_r0_.xyw, vs_r0_.xyw);
    vs_r0_.x = clamp(dot(-(global.vs_uniforms_vec4_[12].xyz), vs_r2_.xyz), 0f, 1f);
    let _e298 = global.vs_uniforms_vec4_[10].xyz;
    vs_r2_.x = _e298.x;
    vs_r2_.y = _e298.y;
    vs_r2_.z = _e298.z;
    let _e316 = ((vs_r0_.xxx * vs_r2_.xyz) + global.vs_uniforms_vec4_[11].xyz);
    vs_r0_.x = _e316.x;
    vs_r0_.y = _e316.y;
    vs_r0_.z = _e316.z;
    if (vs_r1_.x == 0f) {
    ...
    vs_r2_.z = local_2;
    let _e362 = (vs_r3_.xyz * vs_r2_.xyz);
    vs_r3_.x = _e362.x;
    vs_r3_.y = _e362.y;
    vs_r3_.z = _e362.z;
    let _e375 = (vs_r1_.xyz * vs_r2_.xyz);
    vs_r2_.x = _e375.x;
    vs_r2_.y = _e375.y;
    vs_r2_.z = _e375.z;
    let _e390 = (vs_r2_.xyz * global.vs_uniforms_vec4_[26].xyz);
    vs_r2_.x = _e390.x;
    vs_r2_.y = _e390.y;
    vs_r2_.z = _e390.z;
    let _e408 = ((vs_r1_.xyz * global.vs_uniforms_vec4_[27].xyz) + vs_r2_.xyz);
    vs_r1_.x = _e408.x;
    vs_r1_.y = _e408.y;
    vs_r1_.z = _e408.z;
    let _e423 = (vs_r1_.xyz + global.vs_uniforms_vec4_[25].xyz);
    vs_r1_.x = _e423.x;
    vs_r1_.y = _e423.y;
    vs_r1_.z = _e423.z;
    let _e440 = max(vs_r3_.xyz, vec3<f32>(0f, 0f, 0f));
    vs_r2_.x = _e440.x;
    vs_r2_.y = _e440.y;
    vs_r2_.z = _e440.z;
    if (vs_r1_.x == 0f) {
    ...
    vs_r3_.z = local_5;
    let _e486 = (vs_r2_.xyz * vs_r3_.xyz);
    vs_r1_.x = _e486.x;
    vs_r1_.y = _e486.y;
    vs_r1_.z = _e486.z;
    let _e504 = ((global.vs_uniforms_vec4_[17].xyz * vs_r1_.xxx) + vs_r0_.xyz);
    vs_r0_.x = _e504.x;
    vs_r0_.y = _e504.y;
    vs_r0_.z = _e504.z;
    let _e522 = ((global.vs_uniforms_vec4_[18].xyz * vs_r1_.yyy) + vs_r0_.xyz);
    vs_r0_.x = _e522.x;
    vs_r0_.y = _e522.y;
    vs_r0_.z = _e522.z;
    let _e545 = clamp(((global.vs_uniforms_vec4_[19].xyz * vs_r1_.zzz) + vs_r0_.xyz), vec3(0f), vec3(1f));
    vs_r0_.x = _e545.x;
    vs_r0_.y = _e545.y;
    vs_r0_.z = _e545.z;
    vs_r0_.w = 1f;
    ...
    let _e630 = ((vs_v4_.xyx * vec3<f32>(1f, 1f, 0f)) + vec3<f32>(0f, 0f, 1f));
    vs_r0_.x = _e630.x;
    vs_r0_.y = _e630.y;
    vs_r0_.z = _e630.z;
