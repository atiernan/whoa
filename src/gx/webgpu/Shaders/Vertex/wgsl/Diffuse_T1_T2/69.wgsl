...
@vertex fn main(@location(0) vs_v0_: vec4<f32>, @location(3) vs_v1_: vec4<f32>, @location(6) vs_v2_: vec4<f32>, @location(7) vs_v3_: vec4<f32>) -> VertexOutput {
    ...
    let _e249 = (-(vs_r0_.xyz) + global.vs_uniforms_vec4_[24].xyz);
    vs_r6_.x = _e249.x;
    vs_r6_.y = _e249.y;
    vs_r6_.z = _e249.z;
    ...
    let _e411 = ((global.vs_uniforms_vec4_[17].xyz * vs_r3_.xxx) + vs_r2_.xyz);
    vs_r2_.x = _e411.x;
    vs_r2_.y = _e411.y;
    vs_r2_.z = _e411.z;
    let _e429 = ((global.vs_uniforms_vec4_[18].xyz * vs_r3_.yyy) + vs_r2_.xyz);
    vs_r2_.x = _e429.x;
    vs_r2_.y = _e429.y;
    vs_r2_.z = _e429.z;
    let _e447 = ((global.vs_uniforms_vec4_[19].xyz * vs_r3_.zzz) + vs_r2_.xyz);
    vs_r2_.x = _e447.x;
    vs_r2_.y = _e447.y;
    vs_r2_.z = _e447.z;
    let _e470 = clamp(((global.vs_uniforms_vec4_[20].xyz * vs_r3_.www) + vs_r2_.xyz), vec3(0f), vec3(1f));
    vs_r1_.x = _e470.x;
    vs_r1_.y = _e470.y;
    vs_r1_.z = _e470.z;
    ...
    let _e589 = ((vs_v3_.xyx * vec3<f32>(1f, 1f, 0f)) + vec3<f32>(0f, 0f, 1f));
    vs_r1_.x = _e589.x;
    vs_r1_.y = _e589.y;
    vs_r1_.z = _e589.z;
