...
@vertex fn main(@location(0) vs_v0_: vec4<f32>, @location(2) @interpolate(flat) vs_v1_u: vec4<u32>, @location(3) vs_v2_: vec4<f32>, @location(6) vs_v3_: vec4<f32>, @location(7) vs_v4_: vec4<f32>) -> VertexOutput {
    ...
    let _e277 = (-(vs_r0_.xyz) + global.vs_uniforms_vec4_[23].xyz);
    vs_r6_.x = _e277.x;
    vs_r6_.y = _e277.y;
    vs_r6_.z = _e277.z;
    vs_r5_.z = dot(vs_r6_.xyz, vs_r3_.xyz);
    let _e293 = vs_r3_.xyz;
    vs_o5_.x = _e293.x;
    vs_o5_.y = _e293.y;
    vs_o5_.z = _e293.z;
    ...
    vs_r3_.z = local_2;
    let _e345 = (vs_r5_.xyz * vs_r3_.xyz);
    vs_r5_.x = _e345.x;
    vs_r5_.y = _e345.y;
    vs_r5_.z = _e345.z;
    ...
    vs_r3_.y = _e358.y;
    vs_r3_.z = _e358.z;
    let _e373 = (vs_r3_.xyz * global.vs_uniforms_vec4_[26].xyz);
    vs_r3_.x = _e373.x;
    vs_r3_.y = _e373.y;
    vs_r3_.z = _e373.z;
    let _e391 = ((vs_r4_.xyz * global.vs_uniforms_vec4_[27].xyz) + vs_r3_.xyz);
    vs_r3_.x = _e391.x;
    vs_r3_.y = _e391.y;
    vs_r3_.z = _e391.z;
    let _e406 = (vs_r3_.xyz + global.vs_uniforms_vec4_[25].xyz);
    vs_r3_.x = _e406.x;
    vs_r3_.y = _e406.y;
    vs_r3_.z = _e406.z;
    let _e423 = max(vs_r5_.xyz, vec3<f32>(0f, 0f, 0f));
    vs_r4_.x = _e423.x;
    vs_r4_.y = _e423.y;
    vs_r4_.z = _e423.z;
    if (vs_r3_.x == 0f) {
    ...
    vs_r5_.z = local_5;
    let _e469 = (vs_r4_.xyz * vs_r5_.xyz);
    vs_r3_.x = _e469.x;
    vs_r3_.y = _e469.y;
    vs_r3_.z = _e469.z;
    let _e487 = ((global.vs_uniforms_vec4_[17].xyz * vs_r3_.xxx) + vs_r2_.xyz);
    vs_r2_.x = _e487.x;
    vs_r2_.y = _e487.y;
    vs_r2_.z = _e487.z;
    let _e505 = ((global.vs_uniforms_vec4_[18].xyz * vs_r3_.yyy) + vs_r2_.xyz);
    vs_r2_.x = _e505.x;
    vs_r2_.y = _e505.y;
    vs_r2_.z = _e505.z;
    let _e528 = clamp(((global.vs_uniforms_vec4_[19].xyz * vs_r3_.zzz) + vs_r2_.xyz), vec3(0f), vec3(1f));
    vs_r1_.x = _e528.x;
    vs_r1_.y = _e528.y;
    vs_r1_.z = _e528.z;
    ...
    let _e607 = ((vs_v3_.xyx * vec3<f32>(1f, 1f, 0f)) + vec3<f32>(0f, 0f, 1f));
    vs_r1_.x = _e607.x;
    vs_r1_.y = _e607.y;
    vs_r1_.z = _e607.z;
    vs_o2_.x = dot(global.vs_uniforms_vec4_[6].xyw, vs_r1_.xyz);
    vs_o2_.y = dot(global.vs_uniforms_vec4_[7].xyw, vs_r1_.xyz);
    let _e647 = ((vs_v4_.xyx * vec3<f32>(1f, 1f, 0f)) + vec3<f32>(0f, 0f, 1f));
    vs_r1_.x = _e647.x;
    vs_r1_.y = _e647.y;
    vs_r1_.z = _e647.z;
