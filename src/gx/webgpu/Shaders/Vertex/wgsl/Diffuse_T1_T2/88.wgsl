...
@vertex fn main(@location(0) vs_v0_: vec4<f32>, @location(1) vs_v1_: vec4<f32>, @location(2) @interpolate(flat) vs_v2_u: vec4<u32>, @location(3) vs_v3_: vec4<f32>, @location(6) vs_v4_: vec4<f32>, @location(7) vs_v5_: vec4<f32>) -> VertexOutput {
    ...
    vs_r1_.w = local;
    let _e247 = (vs_r1_.xyz * vs_r1_.www);
    vs_o5_.x = _e247.x;
    vs_o5_.y = _e247.y;
    vs_o5_.z = _e247.z;
    vs_r0_.w = 1f;
    ...
    let _e355 = ((vs_v4_.xyx * vec3<f32>(1f, 1f, 0f)) + vec3<f32>(0f, 0f, 1f));
    vs_r1_.x = _e355.x;
    vs_r1_.y = _e355.y;
    vs_r1_.z = _e355.z;
    vs_o2_.x = dot(global.vs_uniforms_vec4_[6].xyw, vs_r1_.xyz);
    vs_o2_.y = dot(global.vs_uniforms_vec4_[7].xyw, vs_r1_.xyz);
    let _e395 = ((vs_v5_.xyx * vec3<f32>(1f, 1f, 0f)) + vec3<f32>(0f, 0f, 1f));
    vs_r1_.x = _e395.x;
    vs_r1_.y = _e395.y;
    vs_r1_.z = _e395.z;
