...
@vertex fn main(@location(0) vs_v0_: vec4<f32>, @location(2) @interpolate(flat) vs_v1_u: vec4<u32>, @location(3) vs_v2_: vec4<f32>, @location(6) vs_v3_: vec4<f32>, @location(7) vs_v4_: vec4<f32>) -> VertexOutput {
    ...
    let _e305 = (-(vs_r0_.xyz) + global.vs_uniforms_vec4_[24].xyz);
    vs_r6_.x = _e305.x;
    vs_r6_.y = _e305.y;
    vs_r6_.z = _e305.z;
    vs_r5_.w = dot(vs_r6_.xyz, vs_r3_.xyz);
    let _e321 = vs_r3_.xyz;
    vs_o5_.x = _e321.x;
    vs_o5_.y = _e321.y;
    vs_o5_.z = _e321.z;
    ...
    let _e467 = ((global.vs_uniforms_vec4_[17].xyz * vs_r3_.xxx) + vs_r2_.xyz);
    vs_r2_.x = _e467.x;
    vs_r2_.y = _e467.y;
    vs_r2_.z = _e467.z;
    let _e485 = ((global.vs_uniforms_vec4_[18].xyz * vs_r3_.yyy) + vs_r2_.xyz);
    vs_r2_.x = _e485.x;
    vs_r2_.y = _e485.y;
    vs_r2_.z = _e485.z;
    let _e503 = ((global.vs_uniforms_vec4_[19].xyz * vs_r3_.zzz) + vs_r2_.xyz);
    vs_r2_.x = _e503.x;
    vs_r2_.y = _e503.y;
    vs_r2_.z = _e503.z;
    let _e526 = clamp(((global.vs_uniforms_vec4_[20].xyz * vs_r3_.www) + vs_r2_.xyz), vec3(0f), vec3(1f));
    vs_r1_.x = _e526.x;
    vs_r1_.y = _e526.y;
    vs_r1_.z = _e526.z;
    ...
    let _e645 = ((vs_v4_.xyx * vec3<f32>(1f, 1f, 0f)) + vec3<f32>(0f, 0f, 1f));
    vs_r1_.x = _e645.x;
    vs_r1_.y = _e645.y;
    vs_r1_.z = _e645.z;
