...
@vertex fn main(@location(0) vs_v0_: vec4<f32>, @location(3) vs_v1_: vec4<f32>, @location(6) vs_v2_: vec4<f32>, @location(7) vs_v3_: vec4<f32>) -> VertexOutput {
    ...
    vs_r3_.z = local_2;
    let _e177 = (vs_r2_.xyz * vs_r3_.xyz);
    vs_r6_.x = _e177.x;
    vs_r6_.y = _e177.y;
    vs_r6_.z = _e177.z;
    let _e192 = (vs_r6_.xyz * global.vs_uniforms_vec4_[26].xyz);
    vs_r6_.x = _e192.x;
    vs_r6_.y = _e192.y;
    vs_r6_.z = _e192.z;
    let _e210 = ((vs_r2_.xyz * global.vs_uniforms_vec4_[27].xyz) + vs_r6_.xyz);
    vs_r2_.x = _e210.x;
    vs_r2_.y = _e210.y;
    vs_r2_.z = _e210.z;
    let _e225 = (vs_r2_.xyz + global.vs_uniforms_vec4_[25].xyz);
    vs_r2_.x = _e225.x;
    vs_r2_.y = _e225.y;
    vs_r2_.z = _e225.z;
    if (vs_r2_.x == 0f) {
    ...
    let _e293 = normalize(vs_r2_.xyz);
    vs_r7_.x = _e293.x;
    vs_r7_.y = _e293.y;
    vs_r7_.z = _e293.z;
    ...
    let _e324 = (vs_r3_.xyz * vs_r1_.xyz);
    vs_r1_.x = _e324.x;
    vs_r1_.y = _e324.y;
    vs_r1_.z = _e324.z;
    let _e341 = max(vs_r1_.xyz, vec3<f32>(0f, 0f, 0f));
    vs_r1_.x = _e341.x;
    vs_r1_.y = _e341.y;
    vs_r1_.z = _e341.z;
    let _e354 = (vs_r6_.xyz * vs_r1_.xyz);
    vs_r1_.x = _e354.x;
    vs_r1_.y = _e354.y;
    vs_r1_.z = _e354.z;
    vs_r1_.w = clamp(dot(-(global.vs_uniforms_vec4_[12].xyz), vs_r7_.xyz), 0f, 1f);
    let _e376 = vs_r7_.xyz;
    vs_o5_.x = _e376.x;
    vs_o5_.y = _e376.y;
    vs_o5_.z = _e376.z;
    let _e388 = global.vs_uniforms_vec4_[10].xyz;
    vs_r2_.x = _e388.x;
    vs_r2_.y = _e388.y;
    vs_r2_.z = _e388.z;
    let _e406 = ((vs_r1_.www * vs_r2_.xyz) + global.vs_uniforms_vec4_[11].xyz);
    vs_r2_.x = _e406.x;
    vs_r2_.y = _e406.y;
    vs_r2_.z = _e406.z;
    let _e424 = ((global.vs_uniforms_vec4_[17].xyz * vs_r1_.xxx) + vs_r2_.xyz);
    vs_r2_.x = _e424.x;
    vs_r2_.y = _e424.y;
    vs_r2_.z = _e424.z;
    let _e442 = ((global.vs_uniforms_vec4_[18].xyz * vs_r1_.yyy) + vs_r2_.xyz);
    vs_r1_.x = _e442.x;
    vs_r1_.y = _e442.y;
    vs_r1_.w = _e442.z;
    let _e465 = clamp(((global.vs_uniforms_vec4_[19].xyz * vs_r1_.zzz) + vs_r1_.xyw), vec3(0f), vec3(1f));
    vs_r1_.x = _e465.x;
    vs_r1_.y = _e465.y;
    vs_r1_.z = _e465.z;
    vs_r1_.w = 1f;
    ...
    let _e550 = ((vs_v2_.xyx * vec3<f32>(1f, 1f, 0f)) + vec3<f32>(0f, 0f, 1f));
    vs_r1_.x = _e550.x;
    vs_r1_.y = _e550.y;
    vs_r1_.z = _e550.z;
