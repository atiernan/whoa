...
@vertex fn main(@location(0) vs_v0_: vec4<f32>, @location(2) @interpolate(flat) vs_v1_u: vec4<u32>, @location(3) vs_v2_: vec4<f32>, @location(6) vs_v3_: vec4<f32>, @location(7) vs_v4_: vec4<f32>) -> VertexOutput {
    ...
    vs_r0_.w = local;
    let _e108 = (vs_r0_.xyz * vs_r0_.www);
    vs_o5_.x = _e108.x;
    vs_o5_.y = _e108.y;
    vs_o5_.z = _e108.z;
    ...
    let _e249 = ((vs_v3_.xyx * vec3<f32>(1f, 1f, 0f)) + vec3<f32>(0f, 0f, 1f));
    vs_r1_.x = _e249.x;
    vs_r1_.y = _e249.y;
    vs_r1_.z = _e249.z;
    vs_o2_.x = dot(global.vs_uniforms_vec4_[6].xyw, vs_r1_.xyz);
    vs_o2_.y = dot(global.vs_uniforms_vec4_[7].xyw, vs_r1_.xyz);
    let _e289 = ((vs_v4_.xyx * vec3<f32>(1f, 1f, 0f)) + vec3<f32>(0f, 0f, 1f));
    vs_r1_.x = _e289.x;
    vs_r1_.y = _e289.y;
    vs_r1_.z = _e289.z;
