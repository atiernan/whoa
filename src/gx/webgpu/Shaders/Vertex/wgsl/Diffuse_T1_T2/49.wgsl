...
@vertex fn main(@location(0) vs_v0_: vec4<f32>, @location(2) @interpolate(flat) vs_v1_u: vec4<u32>, @location(3) vs_v2_: vec4<f32>, @location(6) vs_v3_: vec4<f32>, @location(7) vs_v4_: vec4<f32>) -> VertexOutput {
    ...
    let _e253 = (-(vs_r0_.xyz) + global.vs_uniforms_vec4_[24].xyz);
    vs_r4_.x = _e253.x;
    vs_r4_.y = _e253.y;
    vs_r4_.z = _e253.z;
    ...
    let _e409 = vs_r2_.xyz;
    vs_o5_.x = _e409.x;
    vs_o5_.y = _e409.y;
    vs_o5_.z = _e409.z;
    let _e421 = global.vs_uniforms_vec4_[10].xyz;
    vs_r2_.x = _e421.x;
    vs_r2_.y = _e421.y;
    vs_r2_.z = _e421.z;
    let _e439 = ((vs_r2_.www * vs_r2_.xyz) + global.vs_uniforms_vec4_[11].xyz);
    vs_r2_.x = _e439.x;
    vs_r2_.y = _e439.y;
    vs_r2_.z = _e439.z;
    let _e457 = ((global.vs_uniforms_vec4_[17].xyz * vs_r1_.xxx) + vs_r2_.xyz);
    vs_r2_.x = _e457.x;
    vs_r2_.y = _e457.y;
    vs_r2_.z = _e457.z;
    let _e475 = ((global.vs_uniforms_vec4_[18].xyz * vs_r1_.yyy) + vs_r2_.xyz);
    vs_r2_.x = _e475.x;
    vs_r2_.y = _e475.y;
    vs_r2_.z = _e475.z;
    let _e493 = ((global.vs_uniforms_vec4_[19].xyz * vs_r1_.zzz) + vs_r2_.xyz);
    vs_r1_.x = _e493.x;
    vs_r1_.y = _e493.y;
    vs_r1_.z = _e493.z;
    let _e516 = clamp(((global.vs_uniforms_vec4_[20].xyz * vs_r1_.www) + vs_r1_.xyz), vec3(0f), vec3(1f));
    vs_r1_.x = _e516.x;
    vs_r1_.y = _e516.y;
    vs_r1_.z = _e516.z;
    vs_r1_.w = 1f;
    ...
    let _e641 = ((vs_v4_.xyx * vec3<f32>(1f, 1f, 0f)) + vec3<f32>(0f, 0f, 1f));
    vs_r1_.x = _e641.x;
    vs_r1_.y = _e641.y;
    vs_r1_.z = _e641.z;
