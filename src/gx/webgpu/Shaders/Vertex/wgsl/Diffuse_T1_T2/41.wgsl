...
@vertex fn main(@location(0) vs_v0_: vec4<f32>, @location(2) @interpolate(flat) vs_v1_u: vec4<u32>, @location(3) vs_v2_: vec4<f32>, @location(6) vs_v3_: vec4<f32>, @location(7) vs_v4_: vec4<f32>) -> VertexOutput {
    ...
    vs_r2_.y = _e184.y;
    vs_r2_.z = _e184.z;
    let _e207 = clamp(((vs_r1_.xxx * vs_r2_.xyz) + global.vs_uniforms_vec4_[11].xyz), vec3(0f), vec3(1f));
    vs_r1_.x = _e207.x;
    vs_r1_.y = _e207.y;
    vs_r1_.z = _e207.z;
    vs_r1_.w = 1f;
    ...
    let _e292 = ((vs_v3_.xyx * vec3<f32>(1f, 1f, 0f)) + vec3<f32>(0f, 0f, 1f));
    vs_r1_.x = _e292.x;
    vs_r1_.y = _e292.y;
    vs_r1_.z = _e292.z;
    vs_o2_.x = dot(global.vs_uniforms_vec4_[6].xyw, vs_r1_.xyz);
    vs_o2_.y = dot(global.vs_uniforms_vec4_[7].xyw, vs_r1_.xyz);
    let _e332 = ((vs_v4_.xyx * vec3<f32>(1f, 1f, 0f)) + vec3<f32>(0f, 0f, 1f));
    vs_r1_.x = _e332.x;
    vs_r1_.y = _e332.y;
    vs_r1_.z = _e332.z;
