...
@vertex fn main(@location(0) vs_v0_: vec4<f32>, @location(3) vs_v1_: vec4<f32>, @location(6) vs_v2_: vec4<f32>, @location(7) vs_v3_: vec4<f32>) -> VertexOutput {
    ...
    let _e210 = normalize(vs_r2_.xyz);
    vs_r3_.x = _e210.x;
    vs_r3_.y = _e210.y;
    vs_r3_.z = _e210.z;
    vs_r0_.x = dot(vs_r0_.xyw, vs_r3_.xyz);
    vs_r0_.y = clamp(dot(-(global.vs_uniforms_vec4_[12].xyz), vs_r3_.xyz), 0f, 1f);
    let _e240 = global.vs_uniforms_vec4_[10].xyz;
    vs_r2_.x = _e240.x;
    vs_r2_.y = _e240.y;
    vs_r2_.z = _e240.z;
    let _e258 = ((vs_r0_.yyy * vs_r2_.xyz) + global.vs_uniforms_vec4_[11].xyz);
    vs_r1_.y = _e258.x;
    vs_r1_.z = _e258.y;
    vs_r1_.w = _e258.z;
    ...
    let _e302 = clamp(((global.vs_uniforms_vec4_[17].xyz * vs_r0_.xxx) + vs_r1_.yzw), vec3(0f), vec3(1f));
    vs_r0_.x = _e302.x;
    vs_r0_.y = _e302.y;
    vs_r0_.z = _e302.z;
    vs_r0_.w = 1f;
    ...
    let _e347 = ((vs_v2_.xyx * vec3<f32>(1f, 1f, 0f)) + vec3<f32>(0f, 0f, 1f));
    vs_r0_.x = _e347.x;
    vs_r0_.y = _e347.y;
    vs_r0_.z = _e347.z;
    vs_o2_.x = dot(global.vs_uniforms_vec4_[6].xyw, vs_r0_.xyz);
    vs_o2_.y = dot(global.vs_uniforms_vec4_[7].xyw, vs_r0_.xyz);
    let _e387 = ((vs_v3_.xyx * vec3<f32>(1f, 1f, 0f)) + vec3<f32>(0f, 0f, 1f));
    vs_r0_.x = _e387.x;
    vs_r0_.y = _e387.y;
    vs_r0_.z = _e387.z;
