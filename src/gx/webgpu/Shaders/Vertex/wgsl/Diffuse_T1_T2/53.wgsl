...
@vertex fn main(@location(0) vs_v0_: vec4<f32>, @location(1) vs_v1_: vec4<f32>, @location(2) @interpolate(flat) vs_v2_u: vec4<u32>, @location(3) vs_v3_: vec4<f32>, @location(6) vs_v4_: vec4<f32>, @location(7) vs_v5_: vec4<f32>) -> VertexOutput {
    ...
    let _e437 = clamp(((global.vs_uniforms_vec4_[17].xyz * vs_r0_.www) + vs_r0_.xyz), vec3(0f), vec3(1f));
    vs_r0_.x = _e437.x;
    vs_r0_.y = _e437.y;
    vs_r0_.z = _e437.z;
    vs_r0_.w = 1f;
    ...
    let _e562 = ((vs_v5_.xyx * vec3<f32>(1f, 1f, 0f)) + vec3<f32>(0f, 0f, 1f));
    vs_r0_.x = _e562.x;
    vs_r0_.y = _e562.y;
    vs_r0_.z = _e562.z;
