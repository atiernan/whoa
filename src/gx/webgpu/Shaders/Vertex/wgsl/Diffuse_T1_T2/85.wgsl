...
@vertex fn main(@location(0) vs_v0_: vec4<f32>, @location(1) vs_v1_: vec4<f32>, @location(2) @interpolate(flat) vs_v2_u: vec4<u32>, @location(3) vs_v3_: vec4<f32>, @location(6) vs_v4_: vec4<f32>, @location(7) vs_v5_: vec4<f32>) -> VertexOutput {
    ...
    vs_r2_.y = local_1;
    let _e412 = (vs_r5_.xy * vs_r2_.xy);
    vs_r2_.z = _e412.x;
    vs_r2_.w = _e412.y;
    let _e423 = (vs_r4_.xy * vs_r2_.xy);
    vs_r2_.x = _e423.x;
    vs_r2_.y = _e423.y;
    let _e436 = (vs_r2_.xy * global.vs_uniforms_vec4_[26].xy);
    vs_r2_.x = _e436.x;
    vs_r2_.y = _e436.y;
    let _e452 = ((vs_r4_.xy * global.vs_uniforms_vec4_[27].xy) + vs_r2_.xy);
    vs_r2_.x = _e452.x;
    vs_r2_.y = _e452.y;
    let _e465 = (vs_r2_.xy + global.vs_uniforms_vec4_[25].xy);
    vs_r2_.x = _e465.x;
    vs_r2_.y = _e465.y;
    let _e480 = max(vs_r2_.zw, vec2<f32>(0f, 0f));
    vs_r2_.z = _e480.x;
    vs_r2_.w = _e480.y;
    if (vs_r2_.x == 0f) {
        local_2 = FLT_MAX;
    ...
    vs_r4_.y = local_3;
    let _e513 = (vs_r2_.zw * vs_r4_.xy);
    vs_r2_.x = _e513.x;
    vs_r2_.y = _e513.y;
    let _e529 = ((global.vs_uniforms_vec4_[17].xyz * vs_r2_.xxx) + vs_r3_.xyz);
    vs_r2_.x = _e529.x;
    vs_r2_.z = _e529.y;
    vs_r2_.w = _e529.z;
    let _e552 = clamp(((global.vs_uniforms_vec4_[18].xyz * vs_r2_.yyy) + vs_r2_.xzw), vec3(0f), vec3(1f));
    vs_r0_.x = _e552.x;
    vs_r0_.y = _e552.y;
    vs_r0_.z = _e552.z;
    ...
    let _e631 = ((vs_v4_.xyx * vec3<f32>(1f, 1f, 0f)) + vec3<f32>(0f, 0f, 1f));
    vs_r0_.x = _e631.x;
    vs_r0_.y = _e631.y;
    vs_r0_.z = _e631.z;
    vs_o2_.x = dot(global.vs_uniforms_vec4_[6].xyw, vs_r0_.xyz);
    vs_o2_.y = dot(global.vs_uniforms_vec4_[7].xyw, vs_r0_.xyz);
    let _e671 = ((vs_v5_.xyx * vec3<f32>(1f, 1f, 0f)) + vec3<f32>(0f, 0f, 1f));
    vs_r0_.x = _e671.x;
    vs_r0_.y = _e671.y;
    vs_r0_.z = _e671.z;
