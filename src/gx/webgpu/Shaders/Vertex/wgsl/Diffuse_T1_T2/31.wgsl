...
@vertex fn main(@location(0) vs_v0_: vec4<f32>, @location(3) vs_v1_: vec4<f32>, @location(6) vs_v2_: vec4<f32>, @location(7) vs_v3_: vec4<f32>) -> VertexOutput {
    ...
    vs_r2_.y = _e128.y;
    vs_r2_.z = _e128.z;
    let _e151 = clamp(((vs_r1_.xxx * vs_r2_.xyz) + global.vs_uniforms_vec4_[11].xyz), vec3(0f), vec3(1f));
    vs_r1_.x = _e151.x;
    vs_r1_.y = _e151.y;
    vs_r1_.z = _e151.z;
    vs_r1_.w = 1f;
    ...
    let _e236 = ((vs_v2_.xyx * vec3<f32>(1f, 1f, 0f)) + vec3<f32>(0f, 0f, 1f));
    vs_r1_.x = _e236.x;
    vs_r1_.y = _e236.y;
    vs_r1_.z = _e236.z;
    vs_o2_.x = dot(global.vs_uniforms_vec4_[6].xyw, vs_r1_.xyz);
    vs_o2_.y = dot(global.vs_uniforms_vec4_[7].xyw, vs_r1_.xyz);
    let _e276 = ((vs_v3_.xyx * vec3<f32>(1f, 1f, 0f)) + vec3<f32>(0f, 0f, 1f));
    vs_r1_.x = _e276.x;
    vs_r1_.y = _e276.y;
    vs_r1_.z = _e276.z;
