...
@vertex fn main(@location(0) vs_v0_: vec4<f32>, @location(3) vs_v1_: vec4<f32>, @location(6) vs_v2_: vec4<f32>, @location(7) vs_v3_: vec4<f32>) -> VertexOutput {
    ...
    let _e97 = normalize(vs_r1_.xyz);
    vs_r2_.x = _e97.x;
    vs_r2_.y = _e97.y;
    vs_r2_.z = _e97.z;
    let _e113 = (-(vs_r0_.xyz) + global.vs_uniforms_vec4_[21].xyz);
    vs_r1_.x = _e113.x;
    vs_r1_.y = _e113.y;
    vs_r1_.z = _e113.z;
    vs_r3_.x = dot(vs_r1_.xyz, vs_r2_.xyz);
    vs_r1_.x = dot(vs_r1_.xyz, vs_r1_.xyz);
    let _e141 = (-(vs_r0_.xyz) + global.vs_uniforms_vec4_[22].xyz);
    vs_r4_.x = _e141.x;
    vs_r4_.y = _e141.y;
    vs_r4_.z = _e141.z;
    vs_r3_.y = dot(vs_r4_.xyz, vs_r2_.xyz);
    vs_r1_.y = dot(vs_r4_.xyz, vs_r4_.xyz);
    let _e169 = (-(vs_r0_.xyz) + global.vs_uniforms_vec4_[23].xyz);
    vs_r4_.x = _e169.x;
    vs_r4_.y = _e169.y;
    vs_r4_.z = _e169.z;
    vs_r3_.z = dot(vs_r4_.xyz, vs_r2_.xyz);
    vs_r1_.z = dot(vs_r4_.xyz, vs_r4_.xyz);
    let _e197 = (-(vs_r0_.xyz) + global.vs_uniforms_vec4_[24].xyz);
    vs_r4_.x = _e197.x;
    vs_r4_.y = _e197.y;
    vs_r4_.z = _e197.z;
    ...
    let _e353 = vs_r2_.xyz;
    vs_o5_.x = _e353.x;
    vs_o5_.y = _e353.y;
    vs_o5_.z = _e353.z;
    let _e365 = global.vs_uniforms_vec4_[10].xyz;
    vs_r2_.x = _e365.x;
    vs_r2_.y = _e365.y;
    vs_r2_.z = _e365.z;
    let _e383 = ((vs_r2_.www * vs_r2_.xyz) + global.vs_uniforms_vec4_[11].xyz);
    vs_r2_.x = _e383.x;
    vs_r2_.y = _e383.y;
    vs_r2_.z = _e383.z;
    let _e401 = ((global.vs_uniforms_vec4_[17].xyz * vs_r1_.xxx) + vs_r2_.xyz);
    vs_r2_.x = _e401.x;
    vs_r2_.y = _e401.y;
    vs_r2_.z = _e401.z;
    let _e419 = ((global.vs_uniforms_vec4_[18].xyz * vs_r1_.yyy) + vs_r2_.xyz);
    vs_r2_.x = _e419.x;
    vs_r2_.y = _e419.y;
    vs_r2_.z = _e419.z;
    let _e437 = ((global.vs_uniforms_vec4_[19].xyz * vs_r1_.zzz) + vs_r2_.xyz);
    vs_r1_.x = _e437.x;
    vs_r1_.y = _e437.y;
    vs_r1_.z = _e437.z;
    let _e460 = clamp(((global.vs_uniforms_vec4_[20].xyz * vs_r1_.www) + vs_r1_.xyz), vec3(0f), vec3(1f));
    vs_r1_.x = _e460.x;
    vs_r1_.y = _e460.y;
    vs_r1_.z = _e460.z;
    vs_r1_.w = 1f;
    ...
    let _e545 = ((vs_v2_.xyx * vec3<f32>(1f, 1f, 0f)) + vec3<f32>(0f, 0f, 1f));
    vs_r1_.x = _e545.x;
    vs_r1_.y = _e545.y;
    vs_r1_.z = _e545.z;
    vs_o2_.x = dot(global.vs_uniforms_vec4_[6].xyw, vs_r1_.xyz);
    vs_o2_.y = dot(global.vs_uniforms_vec4_[7].xyw, vs_r1_.xyz);
    let _e585 = ((vs_v3_.xyx * vec3<f32>(1f, 1f, 0f)) + vec3<f32>(0f, 0f, 1f));
    vs_r1_.x = _e585.x;
    vs_r1_.y = _e585.y;
    vs_r1_.z = _e585.z;
