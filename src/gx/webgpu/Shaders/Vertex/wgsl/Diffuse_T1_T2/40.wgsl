...
@vertex fn main(@location(0) vs_v0_: vec4<f32>, @location(2) @interpolate(flat) vs_v1_u: vec4<u32>, @location(3) vs_v2_: vec4<f32>, @location(6) vs_v3_: vec4<f32>, @location(7) vs_v4_: vec4<f32>) -> VertexOutput {
    ...
    vs_r0_.w = local;
    let _e106 = (vs_r0_.xyz * vs_r0_.www);
    vs_o5_.x = _e106.x;
    vs_o5_.y = _e106.y;
    vs_o5_.z = _e106.z;
    ...
    let _e247 = ((vs_v3_.xyx * vec3<f32>(1f, 1f, 0f)) + vec3<f32>(0f, 0f, 1f));
    vs_r1_.x = _e247.x;
    vs_r1_.y = _e247.y;
    vs_r1_.z = _e247.z;
    vs_o2_.x = dot(global.vs_uniforms_vec4_[6].xyw, vs_r1_.xyz);
    vs_o2_.y = dot(global.vs_uniforms_vec4_[7].xyw, vs_r1_.xyz);
    let _e287 = ((vs_v4_.xyx * vec3<f32>(1f, 1f, 0f)) + vec3<f32>(0f, 0f, 1f));
    vs_r1_.x = _e287.x;
    vs_r1_.y = _e287.y;
    vs_r1_.z = _e287.z;
