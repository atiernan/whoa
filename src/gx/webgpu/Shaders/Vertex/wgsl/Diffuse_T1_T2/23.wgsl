...
@vertex fn main(@location(0) vs_v0_: vec4<f32>, @location(1) vs_v1_: vec4<f32>, @location(2) @interpolate(flat) vs_v2_u: vec4<u32>, @location(3) vs_v3_: vec4<f32>, @location(6) vs_v4_: vec4<f32>, @location(7) vs_v5_: vec4<f32>) -> VertexOutput {
    ...
    let _e340 = global.vs_uniforms_vec4_[10].xyz;
    vs_r2_.x = _e340.x;
    vs_r2_.y = _e340.y;
    vs_r2_.z = _e340.z;
    let _e358 = ((vs_r1_.xxx * vs_r2_.xyz) + global.vs_uniforms_vec4_[11].xyz);
    vs_r1_.x = _e358.x;
    vs_r1_.y = _e358.y;
    vs_r1_.z = _e358.z;
    ...
    let _e462 = clamp(((global.vs_uniforms_vec4_[17].xyz * vs_r0_.xxx) + vs_r1_.xyz), vec3(0f), vec3(1f));
    vs_r0_.x = _e462.x;
    vs_r0_.y = _e462.y;
    vs_r0_.z = _e462.z;
    vs_r0_.w = 1f;
    ...
    let _e507 = ((vs_v4_.xyx * vec3<f32>(1f, 1f, 0f)) + vec3<f32>(0f, 0f, 1f));
    vs_r0_.x = _e507.x;
    vs_r0_.y = _e507.y;
    vs_r0_.z = _e507.z;
    vs_o2_.x = dot(global.vs_uniforms_vec4_[6].xyw, vs_r0_.xyz);
    vs_o2_.y = dot(global.vs_uniforms_vec4_[7].xyw, vs_r0_.xyz);
    let _e547 = ((vs_v5_.xyx * vec3<f32>(1f, 1f, 0f)) + vec3<f32>(0f, 0f, 1f));
    vs_r0_.x = _e547.x;
    vs_r0_.y = _e547.y;
    vs_r0_.z = _e547.z;
