...
@fragment fn main(@location(0) ps_v0_: vec4<f32>, @location(1) ps_v1_: vec4<f32>, @location(2) ps_v2_: vec4<f32>, @location(3) ps_v3_: vec4<f32>, @location(4) ps_v4_: vec4<f32>, @location(5) io_5_4_: vec4<f32>, @location(6) io_5_5_: vec4<f32>, @location(7) io_5_6_: vec4<f32>, @location(10) io_11_0_: vec4<f32>) -> FragmentOutput {
    ...
    if (ps_r1_.y != -(ps_r1_.y)) {
        {
            if (10f < ps_v3_.z) {
                {
                    let _e191 = ((io_5_4_.xy * vec2<f32>(0.5f, 0.5f)) + vec2<f32>(0.5f, 0.5f));
                    ps_r1_.y = _e191.x;
                    ps_r1_.z = _e191.y;
                    let _e204 = (ps_r1_.yz + global.ps_uniforms_vec4_[5].xy);
                    ps_r2_.x = _e204.x;
                    ps_r2_.y = _e204.y;
                    let _e217 = (ps_r1_.yz + global.ps_uniforms_vec4_[7].xy);
                    ps_r3_.x = _e217.x;
                    ps_r3_.y = _e217.y;
                    let _e230 = (ps_r1_.yz + global.ps_uniforms_vec4_[9].xy);
                    ps_r4_.x = _e230.x;
                    ps_r4_.y = _e230.y;
                    let _e243 = (ps_r1_.yz + global.ps_uniforms_vec4_[11].xy);
                    ps_r5_.x = _e243.x;
                    ps_r5_.y = _e243.y;
                ...
                {
                    let _e494 = ((io_5_4_.xy * vec2<f32>(0.5f, 0.5f)) + vec2<f32>(0.5f, 0.5f));
                    ps_r1_.z = _e494.x;
                    ps_r1_.w = _e494.y;
                    let _e507 = (ps_r1_.zw + global.ps_uniforms_vec4_[5].xy);
                    ps_r2_.x = _e507.x;
                    ps_r2_.y = _e507.y;
                    let _e520 = (ps_r1_.zw + global.ps_uniforms_vec4_[6].xy);
                    ps_r3_.x = _e520.x;
                    ps_r3_.y = _e520.y;
                    let _e533 = (ps_r1_.zw + global.ps_uniforms_vec4_[7].xy);
                    ps_r4_.x = _e533.x;
                    ps_r4_.y = _e533.y;
                    let _e546 = (ps_r1_.zw + global.ps_uniforms_vec4_[8].xy);
                    ps_r5_.x = _e546.x;
                    ps_r5_.y = _e546.y;
                    let _e559 = (ps_r1_.zw + global.ps_uniforms_vec4_[9].xy);
                    ps_r6_.x = _e559.x;
                    ps_r6_.y = _e559.y;
                    let _e572 = (ps_r1_.zw + global.ps_uniforms_vec4_[10].xy);
                    ps_r7_.x = _e572.x;
                    ps_r7_.y = _e572.y;
                    let _e585 = (ps_r1_.zw + global.ps_uniforms_vec4_[11].xy);
                    ps_r8_.x = _e585.x;
                    ps_r8_.y = _e585.y;
                    let _e598 = (ps_r1_.zw + global.ps_uniforms_vec4_[12].xy);
                    ps_r9_.x = _e598.x;
                    ps_r9_.y = _e598.y;
    ...
    if (ps_r0_.w < 1f) {
        {
            let _e1058 = ((io_5_5_.xy * vec2<f32>(0.5f, 0.5f)) + vec2<f32>(0.5f, 0.5f));
            ps_r1_.y = _e1058.x;
            ps_r1_.z = _e1058.y;
            let _e1071 = (ps_r1_.yz + global.ps_uniforms_vec4_[5].xy);
            ps_r3_.x = _e1071.x;
            ps_r3_.y = _e1071.y;
            let _e1084 = (ps_r1_.yz + global.ps_uniforms_vec4_[7].xy);
            ps_r4_.x = _e1084.x;
            ps_r4_.y = _e1084.y;
            let _e1097 = (ps_r1_.yz + global.ps_uniforms_vec4_[9].xy);
            ps_r5_.x = _e1097.x;
            ps_r5_.y = _e1097.y;
            let _e1110 = (ps_r1_.yz + global.ps_uniforms_vec4_[11].xy);
            ps_r6_.x = _e1110.x;
            ps_r6_.y = _e1110.y;
    ...
    } else {
        {
            ...
            if (ps_r1_.y < 1f) {
                {
                    let _e1359 = ((io_5_6_.xy * vec2<f32>(0.5f, 0.5f)) + vec2<f32>(0.5f, 0.5f));
                    ps_r1_.y = _e1359.x;
                    ps_r1_.z = _e1359.y;
                    let _e1372 = (ps_r1_.yz + global.ps_uniforms_vec4_[5].xy);
                    ps_r3_.x = _e1372.x;
                    ps_r3_.y = _e1372.y;
                    let _e1385 = (ps_r1_.yz + global.ps_uniforms_vec4_[7].xy);
                    ps_r4_.x = _e1385.x;
                    ps_r4_.y = _e1385.y;
                    let _e1398 = (ps_r1_.yz + global.ps_uniforms_vec4_[9].xy);
                    ps_r5_.x = _e1398.x;
                    ps_r5_.y = _e1398.y;
                    let _e1411 = (ps_r1_.yz + global.ps_uniforms_vec4_[11].xy);
                    ps_r6_.x = _e1411.x;
                    ps_r6_.y = _e1411.y;
            ...
            } else {
                {
                    ...
                    let _e1665 = (ps_r3_.xy + global.ps_uniforms_vec4_[5].xy);
                    ps_r4_.x = _e1665.x;
                    ps_r4_.y = _e1665.y;
                    let _e1678 = (ps_r3_.xy + global.ps_uniforms_vec4_[7].xy);
                    ps_r5_.x = _e1678.x;
                    ps_r5_.y = _e1678.y;
                    let _e1691 = (ps_r3_.xy + global.ps_uniforms_vec4_[9].xy);
                    ps_r6_.x = _e1691.x;
                    ps_r6_.y = _e1691.y;
                    let _e1704 = (ps_r3_.xy + global.ps_uniforms_vec4_[11].xy);
                    ps_r7_.x = _e1704.x;
                    ps_r7_.y = _e1704.y;
                    ps_r3_.z = 0f;
                    ps_r3_.w = 0f;
    ...
    let _e2036 = (ps_r0_.www * ps_v0_.xyz);
    ps_r1_.y = _e2036.x;
    ps_r1_.z = _e2036.y;
    ps_r1_.w = _e2036.z;
    let _e2055 = ((ps_r0_.xyz * ps_r1_.yzw) + -(global.ps_uniforms_vec4_[2].xyz));
    ps_r0_.x = _e2055.x;
    ps_r0_.y = _e2055.y;
    ps_r0_.z = _e2055.z;
    let _e2073 = ((io_11_0_.xxx * ps_r0_.xyz) + global.ps_uniforms_vec4_[2].xyz);
    ps_oC0_.x = _e2073.x;
    ps_oC0_.y = _e2073.y;
    ps_oC0_.z = _e2073.z;
    ps_oC0_.w = ps_r1_.x;
