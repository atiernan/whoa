...
@fragment fn main(@location(0) ps_v0_: vec4<f32>, @location(1) ps_v1_: vec4<f32>, @location(2) ps_v2_: vec4<f32>, @location(3) ps_v3_: vec4<f32>, @location(4) ps_v4_: vec4<f32>, @location(5) io_5_4_: vec4<f32>, @location(10) io_11_0_: vec4<f32>) -> FragmentOutput {
    ...
    if (ps_r1_.y != -(ps_r1_.y)) {
        {
            if (10f < ps_v3_.z) {
                {
                    let _e164 = ((io_5_4_.xy * vec2<f32>(0.5f, 0.5f)) + vec2<f32>(0.5f, 0.5f));
                    ps_r1_.y = _e164.x;
                    ps_r1_.z = _e164.y;
                    let _e177 = (ps_r1_.yz + global.ps_uniforms_vec4_[5].xy);
                    ps_r2_.x = _e177.x;
                    ps_r2_.y = _e177.y;
                    let _e190 = (ps_r1_.yz + global.ps_uniforms_vec4_[7].xy);
                    ps_r3_.x = _e190.x;
                    ps_r3_.y = _e190.y;
                    let _e203 = (ps_r1_.yz + global.ps_uniforms_vec4_[9].xy);
                    ps_r4_.x = _e203.x;
                    ps_r4_.y = _e203.y;
                    let _e216 = (ps_r1_.yz + global.ps_uniforms_vec4_[11].xy);
                    ps_r5_.x = _e216.x;
                    ps_r5_.y = _e216.y;
                ...
                {
                    let _e478 = ((io_5_4_.xy * vec2<f32>(0.5f, 0.5f)) + vec2<f32>(0.5f, 0.5f));
                    ps_r1_.y = _e478.x;
                    ps_r1_.z = _e478.y;
                    let _e491 = (ps_r1_.yz + global.ps_uniforms_vec4_[5].xy);
                    ps_r3_.x = _e491.x;
                    ps_r3_.y = _e491.y;
                    let _e504 = (ps_r1_.yz + global.ps_uniforms_vec4_[6].xy);
                    ps_r4_.x = _e504.x;
                    ps_r4_.y = _e504.y;
                    let _e517 = (ps_r1_.yz + global.ps_uniforms_vec4_[7].xy);
                    ps_r5_.x = _e517.x;
                    ps_r5_.y = _e517.y;
                    let _e530 = (ps_r1_.yz + global.ps_uniforms_vec4_[8].xy);
                    ps_r6_.x = _e530.x;
                    ps_r6_.y = _e530.y;
                    let _e543 = (ps_r1_.yz + global.ps_uniforms_vec4_[9].xy);
                    ps_r7_.x = _e543.x;
                    ps_r7_.y = _e543.y;
                    let _e556 = (ps_r1_.yz + global.ps_uniforms_vec4_[10].xy);
                    ps_r8_.x = _e556.x;
                    ps_r8_.y = _e556.y;
                    let _e569 = (ps_r1_.yz + global.ps_uniforms_vec4_[11].xy);
                    ps_r9_.x = _e569.x;
                    ps_r9_.y = _e569.y;
                    let _e582 = (ps_r1_.yz + global.ps_uniforms_vec4_[12].xy);
                    ps_r10_.x = _e582.x;
                    ps_r10_.y = _e582.y;
    ...
    let _e1084 = (ps_r0_.www * ps_v0_.xyz);
    ps_r1_.y = _e1084.x;
    ps_r1_.z = _e1084.y;
    ps_r1_.w = _e1084.z;
    let _e1103 = ((ps_r0_.xyz * ps_r1_.yzw) + -(global.ps_uniforms_vec4_[2].xyz));
    ps_r0_.x = _e1103.x;
    ps_r0_.y = _e1103.y;
    ps_r0_.z = _e1103.z;
    let _e1121 = ((io_11_0_.xxx * ps_r0_.xyz) + global.ps_uniforms_vec4_[2].xyz);
    ps_oC0_.x = _e1121.x;
    ps_oC0_.y = _e1121.y;
    ps_oC0_.z = _e1121.z;
    ps_oC0_.w = ps_r1_.x;
