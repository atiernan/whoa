...
@fragment fn main(@location(0) ps_v0_: vec4<f32>, @location(1) ps_v1_: vec4<f32>, @location(2) ps_v2_: vec4<f32>, @location(3) ps_v3_: vec4<f32>, @location(4) ps_v4_: vec4<f32>, @location(5) io_5_4_: vec4<f32>, @location(6) io_5_5_: vec4<f32>, @location(7) io_5_6_: vec4<f32>, @location(10) io_11_0_: vec4<f32>) -> FragmentOutput {
    ...
    if (ps_r0_.w != -(ps_r0_.w)) {
        {
            if (10f < ps_v3_.z) {
                {
                    let _e141 = ((io_5_4_.xy * vec2<f32>(0.5f, 0.5f)) + vec2<f32>(0.5f, 0.5f));
                    ps_r1_.x = _e141.x;
                    ps_r1_.y = _e141.y;
                    let _e154 = (ps_r1_.xy + global.ps_uniforms_vec4_[5].xy);
                    ps_r2_.x = _e154.x;
                    ps_r2_.y = _e154.y;
                    let _e167 = (ps_r1_.xy + global.ps_uniforms_vec4_[7].xy);
                    ps_r3_.x = _e167.x;
                    ps_r3_.y = _e167.y;
                    let _e180 = (ps_r1_.xy + global.ps_uniforms_vec4_[9].xy);
                    ps_r4_.x = _e180.x;
                    ps_r4_.y = _e180.y;
                    let _e193 = (ps_r1_.xy + global.ps_uniforms_vec4_[11].xy);
                    ps_r1_.x = _e193.x;
                    ps_r1_.y = _e193.y;
                ...
                {
                    let _e426 = ((io_5_4_.xy * vec2<f32>(0.5f, 0.5f)) + vec2<f32>(0.5f, 0.5f));
                    ps_r1_.x = _e426.x;
                    ps_r1_.y = _e426.y;
                    let _e439 = (ps_r1_.xy + global.ps_uniforms_vec4_[5].xy);
                    ps_r2_.x = _e439.x;
                    ps_r2_.y = _e439.y;
                    let _e452 = (ps_r1_.xy + global.ps_uniforms_vec4_[7].xy);
                    ps_r3_.x = _e452.x;
                    ps_r3_.y = _e452.y;
                    let _e465 = (ps_r1_.xy + global.ps_uniforms_vec4_[9].xy);
                    ps_r4_.x = _e465.x;
                    ps_r4_.y = _e465.y;
                    let _e478 = (ps_r1_.xy + global.ps_uniforms_vec4_[11].xy);
                    ps_r1_.x = _e478.x;
                    ps_r1_.y = _e478.y;
                    ps_r5_ = ((io_5_4_.xyxx * vec4<f32>(0.5f, 0.5f, 0f, 0f)) + vec4<f32>(0.5f, 0.5f, 0f, 0f));
                    ps_r5_ = textureSampleLevel(ps_s4_tex, ps_s4_smp, ps_r5_.xy, ps_r5_.w);
    ...
    if (ps_r0_.w < 1f) {
        {
            let _e763 = ((io_5_5_.xy * vec2<f32>(0.5f, 0.5f)) + vec2<f32>(0.5f, 0.5f));
            ps_r1_.x = _e763.x;
            ps_r1_.y = _e763.y;
            let _e776 = (ps_r1_.xy + global.ps_uniforms_vec4_[5].xy);
            ps_r3_.x = _e776.x;
            ps_r3_.y = _e776.y;
            let _e789 = (ps_r1_.xy + global.ps_uniforms_vec4_[7].xy);
            ps_r4_.x = _e789.x;
            ps_r4_.y = _e789.y;
            let _e802 = (ps_r1_.xy + global.ps_uniforms_vec4_[9].xy);
            ps_r5_.x = _e802.x;
            ps_r5_.y = _e802.y;
            let _e815 = (ps_r1_.xy + global.ps_uniforms_vec4_[11].xy);
            ps_r1_.x = _e815.x;
            ps_r1_.y = _e815.y;
    ...
    } else {
        {
            ...
            if (ps_r1_.x < 1f) {
                {
                    let _e1064 = ((io_5_6_.xy * vec2<f32>(0.5f, 0.5f)) + vec2<f32>(0.5f, 0.5f));
                    ps_r1_.x = _e1064.x;
                    ps_r1_.y = _e1064.y;
                    let _e1077 = (ps_r1_.xy + global.ps_uniforms_vec4_[5].xy);
                    ps_r3_.x = _e1077.x;
                    ps_r3_.y = _e1077.y;
                    let _e1090 = (ps_r1_.xy + global.ps_uniforms_vec4_[7].xy);
                    ps_r4_.x = _e1090.x;
                    ps_r4_.y = _e1090.y;
                    let _e1103 = (ps_r1_.xy + global.ps_uniforms_vec4_[9].xy);
                    ps_r5_.x = _e1103.x;
                    ps_r5_.y = _e1103.y;
                    let _e1116 = (ps_r1_.xy + global.ps_uniforms_vec4_[11].xy);
                    ps_r1_.x = _e1116.x;
                    ps_r1_.y = _e1116.y;
            ...
            } else {
                {
                    ...
                    let _e1370 = (ps_r1_.xy + global.ps_uniforms_vec4_[5].xy);
                    ps_r3_.x = _e1370.x;
                    ps_r3_.y = _e1370.y;
                    let _e1383 = (ps_r1_.xy + global.ps_uniforms_vec4_[7].xy);
                    ps_r4_.x = _e1383.x;
                    ps_r4_.y = _e1383.y;
                    let _e1396 = (ps_r1_.xy + global.ps_uniforms_vec4_[9].xy);
                    ps_r5_.x = _e1396.x;
                    ps_r5_.y = _e1396.y;
                    let _e1409 = (ps_r1_.xy + global.ps_uniforms_vec4_[11].xy);
                    ps_r6_.x = _e1409.x;
                    ps_r6_.y = _e1409.y;
                    ps_r1_.z = 0f;
                    ps_r1_.w = 0f;
    ...
    let _e1741 = (ps_r0_.www * ps_v0_.xyz);
    ps_r1_.x = _e1741.x;
    ps_r1_.y = _e1741.y;
    ps_r1_.z = _e1741.z;
    let _e1760 = ((ps_r0_.xyz * ps_r1_.xyz) + -(global.ps_uniforms_vec4_[2].xyz));
    ps_r0_.x = _e1760.x;
    ps_r0_.y = _e1760.y;
    ps_r0_.z = _e1760.z;
    let _e1778 = ((io_11_0_.xxx * ps_r0_.xyz) + global.ps_uniforms_vec4_[2].xyz);
    ps_oC0_.x = _e1778.x;
    ps_oC0_.y = _e1778.y;
    ps_oC0_.z = _e1778.z;
