...
@fragment fn main(@location(0) ps_v0_: vec4<f32>, @location(1) ps_v1_: vec4<f32>, @location(2) ps_v2_: vec4<f32>, @location(3) ps_v3_: vec4<f32>, @location(4) ps_v4_: vec4<f32>, @location(5) io_5_4_: vec4<f32>, @location(6) io_5_5_: vec4<f32>, @location(7) io_5_6_: vec4<f32>, @location(10) io_11_0_: vec4<f32>) -> FragmentOutput {
    ...
    if (ps_r1_.x != -(ps_r1_.x)) {
        {
            if (10f < ps_v3_.z) {
                {
                    let _e154 = ((io_5_4_.xy * vec2<f32>(0.5f, 0.5f)) + vec2<f32>(0.5f, 0.5f));
                    ps_r1_.x = _e154.x;
                    ps_r1_.y = _e154.y;
                    let _e167 = (ps_r1_.xy + global.ps_uniforms_vec4_[5].xy);
                    ps_r2_.x = _e167.x;
                    ps_r2_.y = _e167.y;
                    let _e180 = (ps_r1_.xy + global.ps_uniforms_vec4_[7].xy);
                    ps_r3_.x = _e180.x;
                    ps_r3_.y = _e180.y;
                    let _e193 = (ps_r1_.xy + global.ps_uniforms_vec4_[9].xy);
                    ps_r4_.x = _e193.x;
                    ps_r4_.y = _e193.y;
                    let _e206 = (ps_r1_.xy + global.ps_uniforms_vec4_[11].xy);
                    ps_r1_.x = _e206.x;
                    ps_r1_.y = _e206.y;
                ...
                {
                    let _e459 = ((io_5_4_.xy * vec2<f32>(0.5f, 0.5f)) + vec2<f32>(0.5f, 0.5f));
                    ps_r1_.y = _e459.x;
                    ps_r1_.z = _e459.y;
                    let _e472 = (ps_r1_.yz + global.ps_uniforms_vec4_[5].xy);
                    ps_r2_.x = _e472.x;
                    ps_r2_.y = _e472.y;
                    let _e485 = (ps_r1_.yz + global.ps_uniforms_vec4_[6].xy);
                    ps_r3_.x = _e485.x;
                    ps_r3_.y = _e485.y;
                    let _e498 = (ps_r1_.yz + global.ps_uniforms_vec4_[7].xy);
                    ps_r4_.x = _e498.x;
                    ps_r4_.y = _e498.y;
                    let _e511 = (ps_r1_.yz + global.ps_uniforms_vec4_[8].xy);
                    ps_r5_.x = _e511.x;
                    ps_r5_.y = _e511.y;
                    let _e524 = (ps_r1_.yz + global.ps_uniforms_vec4_[9].xy);
                    ps_r6_.x = _e524.x;
                    ps_r6_.y = _e524.y;
                    let _e537 = (ps_r1_.yz + global.ps_uniforms_vec4_[10].xy);
                    ps_r7_.x = _e537.x;
                    ps_r7_.y = _e537.y;
                    let _e550 = (ps_r1_.yz + global.ps_uniforms_vec4_[11].xy);
                    ps_r8_.x = _e550.x;
                    ps_r8_.y = _e550.y;
                    let _e563 = (ps_r1_.yz + global.ps_uniforms_vec4_[12].xy);
                    ps_r9_.x = _e563.x;
                    ps_r9_.y = _e563.y;
    ...
    if (ps_r0_.w < 1f) {
        {
            let _e1023 = ((io_5_5_.xy * vec2<f32>(0.5f, 0.5f)) + vec2<f32>(0.5f, 0.5f));
            ps_r1_.x = _e1023.x;
            ps_r1_.y = _e1023.y;
            let _e1036 = (ps_r1_.xy + global.ps_uniforms_vec4_[5].xy);
            ps_r3_.x = _e1036.x;
            ps_r3_.y = _e1036.y;
            let _e1049 = (ps_r1_.xy + global.ps_uniforms_vec4_[7].xy);
            ps_r4_.x = _e1049.x;
            ps_r4_.y = _e1049.y;
            let _e1062 = (ps_r1_.xy + global.ps_uniforms_vec4_[9].xy);
            ps_r5_.x = _e1062.x;
            ps_r5_.y = _e1062.y;
            let _e1075 = (ps_r1_.xy + global.ps_uniforms_vec4_[11].xy);
            ps_r1_.x = _e1075.x;
            ps_r1_.y = _e1075.y;
    ...
    } else {
        {
            ...
            if (ps_r1_.x < 1f) {
                {
                    let _e1325 = ((io_5_6_.xy * vec2<f32>(0.5f, 0.5f)) + vec2<f32>(0.5f, 0.5f));
                    ps_r1_.x = _e1325.x;
                    ps_r1_.y = _e1325.y;
                    let _e1338 = (ps_r1_.xy + global.ps_uniforms_vec4_[5].xy);
                    ps_r3_.x = _e1338.x;
                    ps_r3_.y = _e1338.y;
                    let _e1351 = (ps_r1_.xy + global.ps_uniforms_vec4_[7].xy);
                    ps_r4_.x = _e1351.x;
                    ps_r4_.y = _e1351.y;
                    let _e1364 = (ps_r1_.xy + global.ps_uniforms_vec4_[9].xy);
                    ps_r5_.x = _e1364.x;
                    ps_r5_.y = _e1364.y;
                    let _e1377 = (ps_r1_.xy + global.ps_uniforms_vec4_[11].xy);
                    ps_r1_.x = _e1377.x;
                    ps_r1_.y = _e1377.y;
            ...
            } else {
                {
                    ...
                    let _e1632 = (ps_r1_.xy + global.ps_uniforms_vec4_[5].xy);
                    ps_r3_.x = _e1632.x;
                    ps_r3_.y = _e1632.y;
                    let _e1645 = (ps_r1_.xy + global.ps_uniforms_vec4_[7].xy);
                    ps_r4_.x = _e1645.x;
                    ps_r4_.y = _e1645.y;
                    let _e1658 = (ps_r1_.xy + global.ps_uniforms_vec4_[9].xy);
                    ps_r5_.x = _e1658.x;
                    ps_r5_.y = _e1658.y;
                    let _e1671 = (ps_r1_.xy + global.ps_uniforms_vec4_[11].xy);
                    ps_r6_.x = _e1671.x;
                    ps_r6_.y = _e1671.y;
                    ps_r1_.z = 0f;
                    ps_r1_.w = 0f;
    ...
    let _e2005 = (ps_r0_.www * ps_v0_.xyz);
    ps_r1_.x = _e2005.x;
    ps_r1_.y = _e2005.y;
    ps_r1_.z = _e2005.z;
    let _e2024 = ((ps_r0_.xyz * ps_r1_.xyz) + -(global.ps_uniforms_vec4_[2].xyz));
    ps_r0_.x = _e2024.x;
    ps_r0_.y = _e2024.y;
    ps_r0_.z = _e2024.z;
    let _e2042 = ((io_11_0_.xxx * ps_r0_.xyz) + global.ps_uniforms_vec4_[2].xyz);
    ps_oC0_.x = _e2042.x;
    ps_oC0_.y = _e2042.y;
    ps_oC0_.z = _e2042.z;
