...
@fragment fn main(@location(0) ps_v0_: vec4<f32>, @location(1) ps_v1_: vec4<f32>, @location(2) ps_v2_: vec4<f32>, @location(3) ps_v3_: vec4<f32>, @location(4) ps_v4_: vec4<f32>, @location(5) io_5_4_: vec4<f32>, @location(6) io_5_5_: vec4<f32>, @location(7) io_5_6_: vec4<f32>, @location(10) io_11_0_: vec4<f32>) -> FragmentOutput {
            ...
            if (10f < ps_v3_.z) {
                {
                    ...
                    let _e170 = ((io_5_4_.xy * vec2<f32>(0.5f, 0.5f)) + vec2<f32>(0.5f, 0.5f));
                    ps_r1_.y = _e170.x;
                    ps_r1_.z = _e170.y;
                    let _e183 = (ps_r1_.yz + global.ps_uniforms_vec4_[5].xy);
                    ps_r2_.x = _e183.x;
                    ps_r2_.y = _e183.y;
                    let _e198 = (vec2<f32>(1f, 0f) * io_5_4_.zx);
                    ps_r2_.z = _e198.x;
                    ps_r2_.w = _e198.y;
                    ps_r2_ = textureSampleLevel(ps_s4_tex, ps_s4_smp, ps_r2_.xy, ps_r2_.w);
                    ps_r1_.x = (ps_r1_.x + ps_r2_.x);
                    let _e222 = (ps_r1_.yz + global.ps_uniforms_vec4_[7].xy);
                    ps_r2_.x = _e222.x;
                    ps_r2_.y = _e222.y;
                    let _e237 = (vec2<f32>(1f, 0f) * io_5_4_.zx);
                    ps_r2_.z = _e237.x;
                    ps_r2_.w = _e237.y;
                    ps_r2_ = textureSampleLevel(ps_s4_tex, ps_s4_smp, ps_r2_.xy, ps_r2_.w);
                    ps_r1_.x = (ps_r1_.x + ps_r2_.x);
                    let _e261 = (ps_r1_.yz + global.ps_uniforms_vec4_[9].xy);
                    ps_r2_.x = _e261.x;
                    ps_r2_.y = _e261.y;
                    let _e276 = (vec2<f32>(1f, 0f) * io_5_4_.zx);
                    ps_r2_.z = _e276.x;
                    ps_r2_.w = _e276.y;
                    ps_r2_ = textureSampleLevel(ps_s4_tex, ps_s4_smp, ps_r2_.xy, ps_r2_.w);
                    ps_r1_.x = (ps_r1_.x + ps_r2_.x);
                    let _e300 = (ps_r1_.yz + global.ps_uniforms_vec4_[11].xy);
                    ps_r2_.x = _e300.x;
                    ps_r2_.y = _e300.y;
                    let _e315 = (vec2<f32>(1f, 0f) * io_5_4_.zx);
                    ps_r2_.z = _e315.x;
                    ps_r2_.w = _e315.y;
                    ps_r2_ = textureSampleLevel(ps_s4_tex, ps_s4_smp, ps_r2_.xy, ps_r2_.w);
                    ps_r1_.x = (ps_r1_.x + ps_r2_.x);
            ...
            } else {
                {
                    ...
                    ps_r2_ = textureSampleLevel(ps_s4_tex, ps_s4_smp, ps_r2_.xy, ps_r2_.w);
                    let _e398 = ((io_5_4_.xy * vec2<f32>(0.5f, 0.5f)) + vec2<f32>(0.5f, 0.5f));
                    ps_r1_.y = _e398.x;
                    ps_r1_.z = _e398.y;
                    let _e411 = (ps_r1_.yz + global.ps_uniforms_vec4_[5].xy);
                    ps_r3_.x = _e411.x;
                    ps_r3_.y = _e411.y;
                    let _e426 = (vec2<f32>(1f, 0f) * io_5_4_.zx);
                    ps_r3_.z = _e426.x;
                    ps_r3_.w = _e426.y;
                    ps_r3_ = textureSampleLevel(ps_s4_tex, ps_s4_smp, ps_r3_.xy, ps_r3_.w);
                    ps_r1_.w = (ps_r2_.x + ps_r3_.x);
                    let _e450 = (ps_r1_.yz + global.ps_uniforms_vec4_[6].xy);
                    ps_r2_.x = _e450.x;
                    ps_r2_.y = _e450.y;
                    let _e465 = (vec2<f32>(1f, 0f) * io_5_4_.zx);
                    ps_r2_.z = _e465.x;
                    ps_r2_.w = _e465.y;
                    ps_r2_ = textureSampleLevel(ps_s4_tex, ps_s4_smp, ps_r2_.xy, ps_r2_.w);
                    ps_r1_.w = (ps_r1_.w + ps_r2_.x);
                    let _e489 = (ps_r1_.yz + global.ps_uniforms_vec4_[7].xy);
                    ps_r2_.x = _e489.x;
                    ps_r2_.y = _e489.y;
                    let _e504 = (vec2<f32>(1f, 0f) * io_5_4_.zx);
                    ps_r2_.z = _e504.x;
                    ps_r2_.w = _e504.y;
                    ps_r2_ = textureSampleLevel(ps_s4_tex, ps_s4_smp, ps_r2_.xy, ps_r2_.w);
                    ps_r1_.w = (ps_r1_.w + ps_r2_.x);
                    ...
                    ps_r2_.x = _e528.x;
                    ps_r2_.y = _e528.y;
                    let _e543 = (vec2<f32>(1f, 0f) * io_5_4_.zx);
                    ps_r2_.z = _e543.x;
                    ps_r2_.w = _e543.y;
                    ps_r2_ = textureSampleLevel(ps_s4_tex, ps_s4_smp, ps_r2_.xy, ps_r2_.w);
                    ps_r1_.w = (ps_r1_.w + ps_r2_.x);
                    let _e567 = (ps_r1_.yz + global.ps_uniforms_vec4_[9].xy);
                    ps_r2_.x = _e567.x;
                    ps_r2_.y = _e567.y;
                    let _e582 = (vec2<f32>(1f, 0f) * io_5_4_.zx);
                    ps_r2_.z = _e582.x;
                    ps_r2_.w = _e582.y;
                    ps_r2_ = textureSampleLevel(ps_s4_tex, ps_s4_smp, ps_r2_.xy, ps_r2_.w);
                    ps_r1_.w = (ps_r1_.w + ps_r2_.x);
                    let _e606 = (ps_r1_.yz + global.ps_uniforms_vec4_[10].xy);
                    ps_r2_.x = _e606.x;
                    ps_r2_.y = _e606.y;
                    let _e621 = (vec2<f32>(1f, 0f) * io_5_4_.zx);
                    ps_r2_.z = _e621.x;
                    ps_r2_.w = _e621.y;
                    ps_r2_ = textureSampleLevel(ps_s4_tex, ps_s4_smp, ps_r2_.xy, ps_r2_.w);
                    ps_r1_.w = (ps_r1_.w + ps_r2_.x);
                    let _e645 = (ps_r1_.yz + global.ps_uniforms_vec4_[11].xy);
                    ps_r2_.x = _e645.x;
                    ps_r2_.y = _e645.y;
                    let _e660 = (vec2<f32>(1f, 0f) * io_5_4_.zx);
                    ps_r2_.z = _e660.x;
                    ps_r2_.w = _e660.y;
                    ps_r2_ = textureSampleLevel(ps_s4_tex, ps_s4_smp, ps_r2_.xy, ps_r2_.w);
                    ps_r1_.w = (ps_r1_.w + ps_r2_.x);
                    let _e684 = (ps_r1_.yz + global.ps_uniforms_vec4_[12].xy);
                    ps_r2_.x = _e684.x;
                    ps_r2_.y = _e684.y;
                    let _e699 = (vec2<f32>(1f, 0f) * io_5_4_.zx);
                    ps_r2_.z = _e699.x;
                    ps_r2_.w = _e699.y;
                    ps_r2_ = textureSampleLevel(ps_s4_tex, ps_s4_smp, ps_r2_.xy, ps_r2_.w);
    ...
    if (ps_r0_.w < 1f) {
        {
            ...
            let _e832 = ((io_5_5_.xy * vec2<f32>(0.5f, 0.5f)) + vec2<f32>(0.5f, 0.5f));
            ps_r1_.y = _e832.x;
            ps_r1_.z = _e832.y;
            let _e845 = (ps_r1_.yz + global.ps_uniforms_vec4_[5].xy);
            ps_r3_.x = _e845.x;
            ps_r3_.y = _e845.y;
            let _e860 = (vec2<f32>(1f, 0f) * io_5_5_.zx);
            ps_r3_.z = _e860.x;
            ps_r3_.w = _e860.y;
            ps_r3_ = textureSampleLevel(ps_s5_tex, ps_s5_smp, ps_r3_.xy, ps_r3_.w);
            ps_r0_.w = (ps_r1_.x + ps_r3_.x);
            let _e884 = (ps_r1_.yz + global.ps_uniforms_vec4_[7].xy);
            ps_r3_.x = _e884.x;
            ps_r3_.y = _e884.y;
            let _e899 = (vec2<f32>(1f, 0f) * io_5_5_.zx);
            ps_r3_.z = _e899.x;
            ps_r3_.w = _e899.y;
            ps_r3_ = textureSampleLevel(ps_s5_tex, ps_s5_smp, ps_r3_.xy, ps_r3_.w);
            ps_r0_.w = (ps_r0_.w + ps_r3_.x);
            let _e923 = (ps_r1_.yz + global.ps_uniforms_vec4_[9].xy);
            ps_r3_.x = _e923.x;
            ps_r3_.y = _e923.y;
            let _e938 = (vec2<f32>(1f, 0f) * io_5_5_.zx);
            ps_r3_.z = _e938.x;
            ps_r3_.w = _e938.y;
            ps_r3_ = textureSampleLevel(ps_s5_tex, ps_s5_smp, ps_r3_.xy, ps_r3_.w);
            ps_r0_.w = (ps_r0_.w + ps_r3_.x);
            let _e962 = (ps_r1_.yz + global.ps_uniforms_vec4_[11].xy);
            ps_r1_.x = _e962.x;
            ps_r1_.y = _e962.y;
            let _e977 = (vec2<f32>(1f, 0f) * io_5_5_.zx);
            ps_r1_.z = _e977.x;
            ps_r1_.w = _e977.y;
            ps_r1_ = textureSampleLevel(ps_s5_tex, ps_s5_smp, ps_r1_.xy, ps_r1_.w);
            ...
            if (ps_r1_.x < 1f) {
                {
                    ...
                    let _e1057 = ((io_5_6_.xy * vec2<f32>(0.5f, 0.5f)) + vec2<f32>(0.5f, 0.5f));
                    ps_r1_.y = _e1057.x;
                    ps_r1_.z = _e1057.y;
                    let _e1070 = (ps_r1_.yz + global.ps_uniforms_vec4_[5].xy);
                    ps_r3_.x = _e1070.x;
                    ps_r3_.y = _e1070.y;
                    let _e1085 = (vec2<f32>(1f, 0f) * io_5_6_.zx);
                    ps_r3_.z = _e1085.x;
                    ps_r3_.w = _e1085.y;
                    ps_r3_ = textureSampleLevel(ps_s6_tex, ps_s6_smp, ps_r3_.xy, ps_r3_.w);
                    ps_r1_.x = (ps_r1_.x + ps_r3_.x);
                    let _e1109 = (ps_r1_.yz + global.ps_uniforms_vec4_[7].xy);
                    ps_r3_.x = _e1109.x;
                    ps_r3_.y = _e1109.y;
                    let _e1124 = (vec2<f32>(1f, 0f) * io_5_6_.zx);
                    ps_r3_.z = _e1124.x;
                    ps_r3_.w = _e1124.y;
                    ps_r3_ = textureSampleLevel(ps_s6_tex, ps_s6_smp, ps_r3_.xy, ps_r3_.w);
                    ps_r1_.x = (ps_r1_.x + ps_r3_.x);
                    let _e1148 = (ps_r1_.yz + global.ps_uniforms_vec4_[9].xy);
                    ps_r3_.x = _e1148.x;
                    ps_r3_.y = _e1148.y;
                    let _e1163 = (vec2<f32>(1f, 0f) * io_5_6_.zx);
                    ps_r3_.z = _e1163.x;
                    ps_r3_.w = _e1163.y;
                    ps_r3_ = textureSampleLevel(ps_s6_tex, ps_s6_smp, ps_r3_.xy, ps_r3_.w);
                    ps_r1_.x = (ps_r1_.x + ps_r3_.x);
                    let _e1187 = (ps_r1_.yz + global.ps_uniforms_vec4_[11].xy);
                    ps_r3_.x = _e1187.x;
                    ps_r3_.y = _e1187.y;
                    let _e1202 = (vec2<f32>(1f, 0f) * io_5_6_.zx);
                    ps_r3_.z = _e1202.x;
                    ps_r3_.w = _e1202.y;
                    ps_r3_ = textureSampleLevel(ps_s6_tex, ps_s6_smp, ps_r3_.xy, ps_r3_.w);
                    ps_r1_.x = (ps_r1_.x + ps_r3_.x);
                ...
                {
                    let _e1245 = ((io_5_4_.ww * vec2<f32>(0.5f, 0f)) + vec2<f32>(0.5f, 0f));
                    ps_r1_.x = _e1245.x;
                    ps_r1_.w = _e1245.y;
                    ps_r1_.y = ((io_5_5_.w * 0.5f) + 0.5f);
                    ps_r1_.z = io_5_6_.w;
                    ps_r3_ = textureSampleLevel(ps_s7_tex, ps_s7_smp, ps_r1_.xy, ps_r1_.w);
                    let _e1281 = (ps_r1_.xy + global.ps_uniforms_vec4_[5].xy);
                    ps_r4_.x = _e1281.x;
                    ps_r4_.y = _e1281.y;
                    let _e1289 = ps_r1_.zw;
                    ps_r4_.z = _e1289.x;
                    ps_r4_.w = _e1289.y;
                    ps_r5_ = textureSampleLevel(ps_s7_tex, ps_s7_smp, ps_r4_.xy, ps_r4_.w);
                    ps_r1_.z = (ps_r3_.x + ps_r5_.x);
                    let _e1313 = (ps_r1_.xy + global.ps_uniforms_vec4_[7].xy);
                    ps_r4_.x = _e1313.x;
                    ps_r4_.y = _e1313.y;
                    ps_r3_ = textureSampleLevel(ps_s7_tex, ps_s7_smp, ps_r4_.xy, ps_r4_.w);
                    ps_r1_.z = (ps_r1_.z + ps_r3_.x);
                    let _e1337 = (ps_r1_.xy + global.ps_uniforms_vec4_[9].xy);
                    ps_r4_.x = _e1337.x;
                    ps_r4_.y = _e1337.y;
                    ps_r3_ = textureSampleLevel(ps_s7_tex, ps_s7_smp, ps_r4_.xy, ps_r4_.w);
                    ps_r1_.z = (ps_r1_.z + ps_r3_.x);
                    let _e1361 = (ps_r1_.xy + global.ps_uniforms_vec4_[11].xy);
                    ps_r4_.x = _e1361.x;
                    ps_r4_.y = _e1361.y;
                    ps_r3_ = textureSampleLevel(ps_s7_tex, ps_s7_smp, ps_r4_.xy, ps_r4_.w);
    ...
    let _e1510 = (ps_r0_.www * ps_v0_.xyz);
    ps_r1_.x = _e1510.x;
    ps_r1_.y = _e1510.y;
    ps_r1_.z = _e1510.z;
    let _e1529 = ((ps_r0_.xyz * ps_r1_.xyz) + -(global.ps_uniforms_vec4_[2].xyz));
    ps_r0_.x = _e1529.x;
    ps_r0_.y = _e1529.y;
    ps_r0_.z = _e1529.z;
    let _e1547 = ((io_11_0_.xxx * ps_r0_.xyz) + global.ps_uniforms_vec4_[2].xyz);
    ps_oC0_.x = _e1547.x;
    ps_oC0_.y = _e1547.y;
    ps_oC0_.z = _e1547.z;
