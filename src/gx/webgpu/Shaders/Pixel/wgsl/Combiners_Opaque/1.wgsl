...
@fragment fn main(@location(0) ps_v0_: vec4<f32>, @location(1) ps_v1_: vec4<f32>, @location(2) ps_v2_: vec4<f32>, @location(3) ps_v3_: vec4<f32>, @location(4) ps_v4_: vec4<f32>, @location(10) io_11_0_: vec4<f32>) -> FragmentOutput {
    ...
    if (ps_r1_.x != -(ps_r1_.x)) {
        {
            if (10f < ps_v2_.z) {
                {
                    let _e115 = ((ps_v4_.xy * vec2<f32>(0.5f, 0.5f)) + vec2<f32>(0.5f, 0.5f));
                    ps_r1_.x = _e115.x;
                    ps_r1_.y = _e115.y;
                    let _e128 = (ps_r1_.xy + global.ps_uniforms_vec4_[5].xy);
                    ps_r2_.x = _e128.x;
                    ps_r2_.y = _e128.y;
                    let _e141 = (ps_r1_.xy + global.ps_uniforms_vec4_[7].xy);
                    ps_r3_.x = _e141.x;
                    ps_r3_.y = _e141.y;
                    let _e154 = (ps_r1_.xy + global.ps_uniforms_vec4_[9].xy);
                    ps_r4_.x = _e154.x;
                    ps_r4_.y = _e154.y;
                    let _e167 = (ps_r1_.xy + global.ps_uniforms_vec4_[11].xy);
                    ps_r1_.x = _e167.x;
                    ps_r1_.y = _e167.y;
                ...
                {
                    let _e429 = ((ps_v4_.xy * vec2<f32>(0.5f, 0.5f)) + vec2<f32>(0.5f, 0.5f));
                    ps_r1_.x = _e429.x;
                    ps_r1_.y = _e429.y;
                    let _e442 = (ps_r1_.xy + global.ps_uniforms_vec4_[5].xy);
                    ps_r3_.x = _e442.x;
                    ps_r3_.y = _e442.y;
                    let _e455 = (ps_r1_.xy + global.ps_uniforms_vec4_[6].xy);
                    ps_r4_.x = _e455.x;
                    ps_r4_.y = _e455.y;
                    let _e468 = (ps_r1_.xy + global.ps_uniforms_vec4_[7].xy);
                    ps_r5_.x = _e468.x;
                    ps_r5_.y = _e468.y;
                    let _e481 = (ps_r1_.xy + global.ps_uniforms_vec4_[8].xy);
                    ps_r6_.x = _e481.x;
                    ps_r6_.y = _e481.y;
                    let _e494 = (ps_r1_.xy + global.ps_uniforms_vec4_[9].xy);
                    ps_r7_.x = _e494.x;
                    ps_r7_.y = _e494.y;
                    let _e507 = (ps_r1_.xy + global.ps_uniforms_vec4_[10].xy);
                    ps_r8_.x = _e507.x;
                    ps_r8_.y = _e507.y;
                    let _e520 = (ps_r1_.xy + global.ps_uniforms_vec4_[11].xy);
                    ps_r9_.x = _e520.x;
                    ps_r9_.y = _e520.y;
                    let _e533 = (ps_r1_.xy + global.ps_uniforms_vec4_[12].xy);
                    ps_r1_.x = _e533.x;
                    ps_r1_.y = _e533.y;
    ...
    let _e1035 = (ps_r0_.www * ps_v0_.xyz);
    ps_r1_.x = _e1035.x;
    ps_r1_.y = _e1035.y;
    ps_r1_.z = _e1035.z;
    let _e1054 = ((ps_r0_.xyz * ps_r1_.xyz) + -(global.ps_uniforms_vec4_[2].xyz));
    ps_r0_.x = _e1054.x;
    ps_r0_.y = _e1054.y;
    ps_r0_.z = _e1054.z;
    let _e1072 = ((io_11_0_.xxx * ps_r0_.xyz) + global.ps_uniforms_vec4_[2].xyz);
    ps_oC0_.x = _e1072.x;
    ps_oC0_.y = _e1072.y;
    ps_oC0_.z = _e1072.z;
    ps_oC0_.w = ps_v0_.w;
