...
@fragment fn main(@location(0) ps_v0_: vec4<f32>, @location(1) ps_v1_: vec4<f32>, @location(2) ps_v2_: vec4<f32>, @location(3) ps_v3_: vec4<f32>, @location(4) ps_v4_: vec4<f32>, @location(5) io_5_4_: vec4<f32>, @location(6) io_5_5_: vec4<f32>, @location(10) io_11_0_: vec4<f32>) -> FragmentOutput {
    ...
    if (ps_r1_.x != -(ps_r1_.x)) {
        {
            if (10f < ps_v2_.z) {
                {
                    let _e137 = ((ps_v4_.xy * vec2<f32>(0.5f, 0.5f)) + vec2<f32>(0.5f, 0.5f));
                    ps_r1_.x = _e137.x;
                    ps_r1_.y = _e137.y;
                    let _e150 = (ps_r1_.xy + global.ps_uniforms_vec4_[5].xy);
                    ps_r2_.x = _e150.x;
                    ps_r2_.y = _e150.y;
                    let _e163 = (ps_r1_.xy + global.ps_uniforms_vec4_[7].xy);
                    ps_r3_.x = _e163.x;
                    ps_r3_.y = _e163.y;
                    let _e176 = (ps_r1_.xy + global.ps_uniforms_vec4_[9].xy);
                    ps_r4_.x = _e176.x;
                    ps_r4_.y = _e176.y;
                    let _e189 = (ps_r1_.xy + global.ps_uniforms_vec4_[11].xy);
                    ps_r1_.x = _e189.x;
                    ps_r1_.y = _e189.y;
                ...
                {
                    let _e442 = ((ps_v4_.xy * vec2<f32>(0.5f, 0.5f)) + vec2<f32>(0.5f, 0.5f));
                    ps_r1_.y = _e442.x;
                    ps_r1_.z = _e442.y;
                    let _e455 = (ps_r1_.yz + global.ps_uniforms_vec4_[5].xy);
                    ps_r2_.x = _e455.x;
                    ps_r2_.y = _e455.y;
                    let _e468 = (ps_r1_.yz + global.ps_uniforms_vec4_[6].xy);
                    ps_r3_.x = _e468.x;
                    ps_r3_.y = _e468.y;
                    let _e481 = (ps_r1_.yz + global.ps_uniforms_vec4_[7].xy);
                    ps_r4_.x = _e481.x;
                    ps_r4_.y = _e481.y;
                    let _e494 = (ps_r1_.yz + global.ps_uniforms_vec4_[8].xy);
                    ps_r5_.x = _e494.x;
                    ps_r5_.y = _e494.y;
                    let _e507 = (ps_r1_.yz + global.ps_uniforms_vec4_[9].xy);
                    ps_r6_.x = _e507.x;
                    ps_r6_.y = _e507.y;
                    let _e520 = (ps_r1_.yz + global.ps_uniforms_vec4_[10].xy);
                    ps_r7_.x = _e520.x;
                    ps_r7_.y = _e520.y;
                    let _e533 = (ps_r1_.yz + global.ps_uniforms_vec4_[11].xy);
                    ps_r8_.x = _e533.x;
                    ps_r8_.y = _e533.y;
                    let _e546 = (ps_r1_.yz + global.ps_uniforms_vec4_[12].xy);
                    ps_r9_.x = _e546.x;
                    ps_r9_.y = _e546.y;
    ...
    if (ps_r0_.w < 1f) {
        {
            let _e1006 = ((io_5_4_.xy * vec2<f32>(0.5f, 0.5f)) + vec2<f32>(0.5f, 0.5f));
            ps_r1_.x = _e1006.x;
            ps_r1_.y = _e1006.y;
            let _e1019 = (ps_r1_.xy + global.ps_uniforms_vec4_[5].xy);
            ps_r3_.x = _e1019.x;
            ps_r3_.y = _e1019.y;
            let _e1032 = (ps_r1_.xy + global.ps_uniforms_vec4_[7].xy);
            ps_r4_.x = _e1032.x;
            ps_r4_.y = _e1032.y;
            let _e1045 = (ps_r1_.xy + global.ps_uniforms_vec4_[9].xy);
            ps_r5_.x = _e1045.x;
            ps_r5_.y = _e1045.y;
            let _e1058 = (ps_r1_.xy + global.ps_uniforms_vec4_[11].xy);
            ps_r1_.x = _e1058.x;
            ps_r1_.y = _e1058.y;
    ...
    } else {
        {
            ...
            if (ps_r1_.x < 1f) {
                {
                    let _e1308 = ((io_5_5_.xy * vec2<f32>(0.5f, 0.5f)) + vec2<f32>(0.5f, 0.5f));
                    ps_r1_.x = _e1308.x;
                    ps_r1_.y = _e1308.y;
                    let _e1321 = (ps_r1_.xy + global.ps_uniforms_vec4_[5].xy);
                    ps_r3_.x = _e1321.x;
                    ps_r3_.y = _e1321.y;
                    let _e1334 = (ps_r1_.xy + global.ps_uniforms_vec4_[7].xy);
                    ps_r4_.x = _e1334.x;
                    ps_r4_.y = _e1334.y;
                    let _e1347 = (ps_r1_.xy + global.ps_uniforms_vec4_[9].xy);
                    ps_r5_.x = _e1347.x;
                    ps_r5_.y = _e1347.y;
                    let _e1360 = (ps_r1_.xy + global.ps_uniforms_vec4_[11].xy);
                    ps_r1_.x = _e1360.x;
                    ps_r1_.y = _e1360.y;
            ...
            } else {
                {
                    ...
                    let _e1615 = (ps_r1_.xy + global.ps_uniforms_vec4_[5].xy);
                    ps_r3_.x = _e1615.x;
                    ps_r3_.y = _e1615.y;
                    let _e1628 = (ps_r1_.xy + global.ps_uniforms_vec4_[7].xy);
                    ps_r4_.x = _e1628.x;
                    ps_r4_.y = _e1628.y;
                    let _e1641 = (ps_r1_.xy + global.ps_uniforms_vec4_[9].xy);
                    ps_r5_.x = _e1641.x;
                    ps_r5_.y = _e1641.y;
                    let _e1654 = (ps_r1_.xy + global.ps_uniforms_vec4_[11].xy);
                    ps_r6_.x = _e1654.x;
                    ps_r6_.y = _e1654.y;
                    ps_r1_.z = 0f;
                    ps_r1_.w = 0f;
    ...
    let _e1988 = (ps_r0_.www * ps_v0_.xyz);
    ps_r1_.x = _e1988.x;
    ps_r1_.y = _e1988.y;
    ps_r1_.z = _e1988.z;
    let _e2007 = ((ps_r0_.xyz * ps_r1_.xyz) + -(global.ps_uniforms_vec4_[2].xyz));
    ps_r0_.x = _e2007.x;
    ps_r0_.y = _e2007.y;
    ps_r0_.z = _e2007.z;
    let _e2025 = ((io_11_0_.xxx * ps_r0_.xyz) + global.ps_uniforms_vec4_[2].xyz);
    ps_oC0_.x = _e2025.x;
    ps_oC0_.y = _e2025.y;
    ps_oC0_.z = _e2025.z;
    ps_oC0_.w = ps_v0_.w;
