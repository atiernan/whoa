...
@fragment fn main(@location(0) ps_v0_: vec4<f32>, @location(1) ps_v1_: vec4<f32>, @location(2) ps_v2_: vec4<f32>, @location(3) ps_v3_: vec4<f32>, @location(4) ps_v4_: vec4<f32>, @location(5) io_5_4_: vec4<f32>, @location(6) io_5_5_: vec4<f32>, @location(10) io_11_0_: vec4<f32>) -> FragmentOutput {
    ...
    if (ps_r1_.x != -(ps_r1_.x)) {
        {
            if (10f < ps_v2_.z) {
                {
                    let _e123 = ((ps_v4_.xy * vec2<f32>(0.5f, 0.5f)) + vec2<f32>(0.5f, 0.5f));
                    ps_r1_.x = _e123.x;
                    ps_r1_.y = _e123.y;
                    let _e136 = (ps_r1_.xy + global.ps_uniforms_vec4_[5].xy);
                    ps_r2_.x = _e136.x;
                    ps_r2_.y = _e136.y;
                    let _e149 = (ps_r1_.xy + global.ps_uniforms_vec4_[7].xy);
                    ps_r3_.x = _e149.x;
                    ps_r3_.y = _e149.y;
                    let _e162 = (ps_r1_.xy + global.ps_uniforms_vec4_[9].xy);
                    ps_r4_.x = _e162.x;
                    ps_r4_.y = _e162.y;
                    let _e175 = (ps_r1_.xy + global.ps_uniforms_vec4_[11].xy);
                    ps_r1_.x = _e175.x;
                    ps_r1_.y = _e175.y;
                ...
                {
                    let _e428 = ((ps_v4_.xy * vec2<f32>(0.5f, 0.5f)) + vec2<f32>(0.5f, 0.5f));
                    ps_r1_.y = _e428.x;
                    ps_r1_.z = _e428.y;
                    let _e441 = (ps_r1_.yz + global.ps_uniforms_vec4_[5].xy);
                    ps_r2_.x = _e441.x;
                    ps_r2_.y = _e441.y;
                    let _e454 = (ps_r1_.yz + global.ps_uniforms_vec4_[6].xy);
                    ps_r3_.x = _e454.x;
                    ps_r3_.y = _e454.y;
                    let _e467 = (ps_r1_.yz + global.ps_uniforms_vec4_[7].xy);
                    ps_r4_.x = _e467.x;
                    ps_r4_.y = _e467.y;
                    let _e480 = (ps_r1_.yz + global.ps_uniforms_vec4_[8].xy);
                    ps_r5_.x = _e480.x;
                    ps_r5_.y = _e480.y;
                    let _e493 = (ps_r1_.yz + global.ps_uniforms_vec4_[9].xy);
                    ps_r6_.x = _e493.x;
                    ps_r6_.y = _e493.y;
                    let _e506 = (ps_r1_.yz + global.ps_uniforms_vec4_[10].xy);
                    ps_r7_.x = _e506.x;
                    ps_r7_.y = _e506.y;
                    let _e519 = (ps_r1_.yz + global.ps_uniforms_vec4_[11].xy);
                    ps_r8_.x = _e519.x;
                    ps_r8_.y = _e519.y;
                    let _e532 = (ps_r1_.yz + global.ps_uniforms_vec4_[12].xy);
                    ps_r9_.x = _e532.x;
                    ps_r9_.y = _e532.y;
    ...
    if (ps_r0_.w < 1f) {
        {
            let _e992 = ((io_5_4_.xy * vec2<f32>(0.5f, 0.5f)) + vec2<f32>(0.5f, 0.5f));
            ps_r1_.x = _e992.x;
            ps_r1_.y = _e992.y;
            let _e1005 = (ps_r1_.xy + global.ps_uniforms_vec4_[5].xy);
            ps_r3_.x = _e1005.x;
            ps_r3_.y = _e1005.y;
            let _e1018 = (ps_r1_.xy + global.ps_uniforms_vec4_[7].xy);
            ps_r4_.x = _e1018.x;
            ps_r4_.y = _e1018.y;
            let _e1031 = (ps_r1_.xy + global.ps_uniforms_vec4_[9].xy);
            ps_r5_.x = _e1031.x;
            ps_r5_.y = _e1031.y;
            let _e1044 = (ps_r1_.xy + global.ps_uniforms_vec4_[11].xy);
            ps_r1_.x = _e1044.x;
            ps_r1_.y = _e1044.y;
    ...
    } else {
        {
            ...
            if (ps_r1_.x < 1f) {
                {
                    let _e1294 = ((io_5_5_.xy * vec2<f32>(0.5f, 0.5f)) + vec2<f32>(0.5f, 0.5f));
                    ps_r1_.x = _e1294.x;
                    ps_r1_.y = _e1294.y;
                    let _e1307 = (ps_r1_.xy + global.ps_uniforms_vec4_[5].xy);
                    ps_r3_.x = _e1307.x;
                    ps_r3_.y = _e1307.y;
                    let _e1320 = (ps_r1_.xy + global.ps_uniforms_vec4_[7].xy);
                    ps_r4_.x = _e1320.x;
                    ps_r4_.y = _e1320.y;
                    let _e1333 = (ps_r1_.xy + global.ps_uniforms_vec4_[9].xy);
                    ps_r5_.x = _e1333.x;
                    ps_r5_.y = _e1333.y;
                    let _e1346 = (ps_r1_.xy + global.ps_uniforms_vec4_[11].xy);
                    ps_r1_.x = _e1346.x;
                    ps_r1_.y = _e1346.y;
            ...
            } else {
                {
                    ...
                    let _e1601 = (ps_r1_.xy + global.ps_uniforms_vec4_[5].xy);
                    ps_r3_.x = _e1601.x;
                    ps_r3_.y = _e1601.y;
                    let _e1614 = (ps_r1_.xy + global.ps_uniforms_vec4_[7].xy);
                    ps_r4_.x = _e1614.x;
                    ps_r4_.y = _e1614.y;
                    let _e1627 = (ps_r1_.xy + global.ps_uniforms_vec4_[9].xy);
                    ps_r5_.x = _e1627.x;
                    ps_r5_.y = _e1627.y;
                    let _e1640 = (ps_r1_.xy + global.ps_uniforms_vec4_[11].xy);
                    ps_r6_.x = _e1640.x;
                    ps_r6_.y = _e1640.y;
                    ps_r1_.z = 0f;
                    ps_r1_.w = 0f;
    ...
    let _e1974 = (ps_r0_.www * ps_v0_.xyz);
    ps_r1_.x = _e1974.x;
    ps_r1_.y = _e1974.y;
    ps_r1_.z = _e1974.z;
    let _e1993 = ((ps_r0_.xyz * ps_r1_.xyz) + -(global.ps_uniforms_vec4_[2].xyz));
    ps_r0_.x = _e1993.x;
    ps_r0_.y = _e1993.y;
    ps_r0_.z = _e1993.z;
    let _e2011 = ((io_11_0_.xxx * ps_r0_.xyz) + global.ps_uniforms_vec4_[2].xyz);
    ps_oC0_.x = _e2011.x;
    ps_oC0_.y = _e2011.y;
    ps_oC0_.z = _e2011.z;
    ps_oC0_.w = ps_v0_.w;
