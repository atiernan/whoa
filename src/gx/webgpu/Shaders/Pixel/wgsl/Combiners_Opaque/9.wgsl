...
@fragment fn main(@location(0) ps_v0_: vec4<f32>, @location(1) ps_v1_: vec4<f32>, @location(2) ps_v2_: vec4<f32>, @location(3) ps_v3_: vec4<f32>, @location(4) ps_v4_: vec4<f32>, @location(10) io_11_0_: vec4<f32>) -> FragmentOutput {
    ...
    if (ps_r1_.x != -(ps_r1_.x)) {
        {
            if (10f < ps_v2_.z) {
                ...
                {
                    let _e443 = ((ps_v4_.xy * vec2<f32>(0.5f, 0.5f)) + vec2<f32>(0.5f, 0.5f));
                    ps_r1_.x = _e443.x;
                    ps_r1_.y = _e443.y;
                    let _e456 = (ps_r1_.xy + global.ps_uniforms_vec4_[5].xy);
                    ps_r3_.x = _e456.x;
                    ps_r3_.y = _e456.y;
                    let _e469 = (ps_r1_.xy + global.ps_uniforms_vec4_[6].xy);
                    ps_r4_.x = _e469.x;
                    ps_r4_.y = _e469.y;
                    let _e482 = (ps_r1_.xy + global.ps_uniforms_vec4_[7].xy);
                    ps_r5_.x = _e482.x;
                    ps_r5_.y = _e482.y;
                    let _e495 = (ps_r1_.xy + global.ps_uniforms_vec4_[8].xy);
                    ps_r6_.x = _e495.x;
                    ps_r6_.y = _e495.y;
                    let _e508 = (ps_r1_.xy + global.ps_uniforms_vec4_[9].xy);
                    ps_r7_.x = _e508.x;
                    ps_r7_.y = _e508.y;
                    let _e521 = (ps_r1_.xy + global.ps_uniforms_vec4_[10].xy);
                    ps_r8_.x = _e521.x;
                    ps_r8_.y = _e521.y;
                    let _e534 = (ps_r1_.xy + global.ps_uniforms_vec4_[11].xy);
                    ps_r9_.x = _e534.x;
                    ps_r9_.y = _e534.y;
                    let _e547 = (ps_r1_.xy + global.ps_uniforms_vec4_[12].xy);
                    ps_r1_.x = _e547.x;
                    ps_r1_.y = _e547.y;
    ...
    let _e1049 = (ps_r0_.www * ps_v0_.xyz);
    ps_r1_.x = _e1049.x;
    ps_r1_.y = _e1049.y;
    ps_r1_.z = _e1049.z;
    let _e1068 = ((ps_r0_.xyz * ps_r1_.xyz) + -(global.ps_uniforms_vec4_[2].xyz));
    ps_r0_.x = _e1068.x;
    ps_r0_.y = _e1068.y;
    ps_r0_.z = _e1068.z;
    let _e1086 = ((io_11_0_.xxx * ps_r0_.xyz) + global.ps_uniforms_vec4_[2].xyz);
    ps_oC0_.x = _e1086.x;
    ps_oC0_.y = _e1086.y;
    ps_oC0_.z = _e1086.z;
    ps_oC0_.w = ps_v0_.w;
