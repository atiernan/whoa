...
@fragment fn main(@location(0) ps_v0_: vec4<f32>, @location(1) ps_v1_: vec4<f32>, @location(10) io_11_0_: vec4<f32>) -> FragmentOutput {
    ...
    ps_r0_ = (-(global.ps_uniforms_vec4_[2].wwww) + ps_v0_.wwww);
    if any((ps_r0_.xyz < vec3(0f))) {
        discard;
    }
    ps_r0_ = textureSample(ps_s0_tex, ps_s0_smp, ps_v1_.xy);
    let _e38 = ((ps_r0_.xyz * ps_v0_.xyz) + -(global.ps_uniforms_vec4_[2].xyz));
    ps_r0_.x = _e38.x;
    ps_r0_.y = _e38.y;
    ps_r0_.z = _e38.z;
    let _e56 = ((io_11_0_.xxx * ps_r0_.xyz) + global.ps_uniforms_vec4_[2].xyz);
    ps_oC0_.x = _e56.x;
    ps_oC0_.y = _e56.y;
    ps_oC0_.z = _e56.z;
    ps_oC0_.w = ps_v0_.w;
