...
@fragment fn main(@location(0) ps_v0_: vec4<f32>, @location(1) ps_v1_: vec4<f32>, @location(2) ps_v2_: vec4<f32>, @location(3) ps_v3_: vec4<f32>, @location(4) ps_v4_: vec4<f32>, @location(5) io_5_4_: vec4<f32>, @location(6) io_5_5_: vec4<f32>, @location(7) io_5_6_: vec4<f32>, @location(10) io_11_0_: vec4<f32>) -> FragmentOutput {
    ...
    if (ps_r0_.w != -(ps_r0_.w)) {
        {
            if (10f < ps_v3_.z) {
                ...
                {
                    let _e439 = ((io_5_4_.xy * vec2<f32>(0.5f, 0.5f)) + vec2<f32>(0.5f, 0.5f));
                    ps_r1_.x = _e439.x;
                    ps_r1_.y = _e439.y;
                    let _e452 = (ps_r1_.xy + global.ps_uniforms_vec4_[5].xy);
                    ps_r2_.x = _e452.x;
                    ps_r2_.y = _e452.y;
                    let _e465 = (ps_r1_.xy + global.ps_uniforms_vec4_[7].xy);
                    ps_r3_.x = _e465.x;
                    ps_r3_.y = _e465.y;
                    let _e478 = (ps_r1_.xy + global.ps_uniforms_vec4_[9].xy);
                    ps_r4_.x = _e478.x;
                    ps_r4_.y = _e478.y;
                    let _e491 = (ps_r1_.xy + global.ps_uniforms_vec4_[11].xy);
                    ps_r1_.x = _e491.x;
                    ps_r1_.y = _e491.y;
                    ps_r5_ = ((io_5_4_.xyxx * vec4<f32>(0.5f, 0.5f, 0f, 0f)) + vec4<f32>(0.5f, 0.5f, 0f, 0f));
                    ps_r5_ = textureSampleLevel(ps_s4_tex, ps_s4_smp, ps_r5_.xy, ps_r5_.w);
    ...
    if (ps_r0_.w < 1f) {
        {
            let _e776 = ((io_5_5_.xy * vec2<f32>(0.5f, 0.5f)) + vec2<f32>(0.5f, 0.5f));
            ps_r1_.x = _e776.x;
            ps_r1_.y = _e776.y;
            let _e789 = (ps_r1_.xy + global.ps_uniforms_vec4_[5].xy);
            ps_r3_.x = _e789.x;
            ps_r3_.y = _e789.y;
            let _e802 = (ps_r1_.xy + global.ps_uniforms_vec4_[7].xy);
            ps_r4_.x = _e802.x;
            ps_r4_.y = _e802.y;
            let _e815 = (ps_r1_.xy + global.ps_uniforms_vec4_[9].xy);
            ps_r5_.x = _e815.x;
            ps_r5_.y = _e815.y;
            let _e828 = (ps_r1_.xy + global.ps_uniforms_vec4_[11].xy);
            ps_r1_.x = _e828.x;
            ps_r1_.y = _e828.y;
    ...
    } else {
        {
            ...
            if (ps_r1_.x < 1f) {
                {
                    let _e1077 = ((io_5_6_.xy * vec2<f32>(0.5f, 0.5f)) + vec2<f32>(0.5f, 0.5f));
                    ps_r1_.x = _e1077.x;
                    ps_r1_.y = _e1077.y;
                    let _e1090 = (ps_r1_.xy + global.ps_uniforms_vec4_[5].xy);
                    ps_r3_.x = _e1090.x;
                    ps_r3_.y = _e1090.y;
                    let _e1103 = (ps_r1_.xy + global.ps_uniforms_vec4_[7].xy);
                    ps_r4_.x = _e1103.x;
                    ps_r4_.y = _e1103.y;
                    let _e1116 = (ps_r1_.xy + global.ps_uniforms_vec4_[9].xy);
                    ps_r5_.x = _e1116.x;
                    ps_r5_.y = _e1116.y;
                    let _e1129 = (ps_r1_.xy + global.ps_uniforms_vec4_[11].xy);
                    ps_r1_.x = _e1129.x;
                    ps_r1_.y = _e1129.y;
            ...
            } else {
                {
                    ...
                    let _e1383 = (ps_r1_.xy + global.ps_uniforms_vec4_[5].xy);
                    ps_r3_.x = _e1383.x;
                    ps_r3_.y = _e1383.y;
                    let _e1396 = (ps_r1_.xy + global.ps_uniforms_vec4_[7].xy);
                    ps_r4_.x = _e1396.x;
                    ps_r4_.y = _e1396.y;
                    let _e1409 = (ps_r1_.xy + global.ps_uniforms_vec4_[9].xy);
                    ps_r5_.x = _e1409.x;
                    ps_r5_.y = _e1409.y;
                    let _e1422 = (ps_r1_.xy + global.ps_uniforms_vec4_[11].xy);
                    ps_r6_.x = _e1422.x;
                    ps_r6_.y = _e1422.y;
                    ps_r1_.z = 0f;
                    ps_r1_.w = 0f;
    ...
    let _e1754 = (ps_r0_.www * ps_v0_.xyz);
    ps_r1_.x = _e1754.x;
    ps_r1_.y = _e1754.y;
    ps_r1_.z = _e1754.z;
    let _e1773 = ((ps_r0_.xyz * ps_r1_.xyz) + -(global.ps_uniforms_vec4_[2].xyz));
    ps_r0_.x = _e1773.x;
    ps_r0_.y = _e1773.y;
    ps_r0_.z = _e1773.z;
    let _e1791 = ((io_11_0_.xxx * ps_r0_.xyz) + global.ps_uniforms_vec4_[2].xyz);
    ps_oC0_.x = _e1791.x;
    ps_oC0_.y = _e1791.y;
    ps_oC0_.z = _e1791.z;
