...
@fragment fn main(@location(0) ps_v0_: vec4<f32>, @location(1) ps_v1_: vec4<f32>, @location(2) ps_v2_: vec4<f32>, @location(3) ps_v3_: vec4<f32>, @location(4) ps_v4_: vec4<f32>, @location(5) io_5_4_: vec4<f32>, @location(10) io_11_0_: vec4<f32>) -> FragmentOutput {
            ...
            if (10f < ps_v3_.z) {
                {
                    ...
                    ps_r1_.x = _e159.x;
                    ps_r1_.y = _e159.y;
                    let _e172 = (ps_r1_.xy + global.ps_uniforms_vec4_[5].xy);
                    ps_r2_.x = _e172.x;
                    ps_r2_.y = _e172.y;
                    let _e185 = (ps_r1_.xy + global.ps_uniforms_vec4_[7].xy);
                    ps_r3_.x = _e185.x;
                    ps_r3_.y = _e185.y;
                    let _e198 = (ps_r1_.xy + global.ps_uniforms_vec4_[9].xy);
                    ps_r4_.x = _e198.x;
                    ps_r4_.y = _e198.y;
                    let _e211 = (ps_r1_.xy + global.ps_uniforms_vec4_[11].xy);
                    ps_r1_.x = _e211.x;
                    ps_r1_.y = _e211.y;
                ...
                {
                    let _e471 = ((io_5_4_.xy * vec2<f32>(0.5f, 0.5f)) + vec2<f32>(0.5f, 0.5f));
                    ps_r1_.x = _e471.x;
                    ps_r1_.y = _e471.y;
                    let _e484 = (ps_r1_.xy + global.ps_uniforms_vec4_[5].xy);
                    ps_r3_.x = _e484.x;
                    ps_r3_.y = _e484.y;
                    let _e497 = (ps_r1_.xy + global.ps_uniforms_vec4_[6].xy);
                    ps_r4_.x = _e497.x;
                    ps_r4_.y = _e497.y;
                    let _e510 = (ps_r1_.xy + global.ps_uniforms_vec4_[7].xy);
                    ps_r5_.x = _e510.x;
                    ps_r5_.y = _e510.y;
                    let _e523 = (ps_r1_.xy + global.ps_uniforms_vec4_[8].xy);
                    ps_r6_.x = _e523.x;
                    ps_r6_.y = _e523.y;
                    let _e536 = (ps_r1_.xy + global.ps_uniforms_vec4_[9].xy);
                    ps_r7_.x = _e536.x;
                    ps_r7_.y = _e536.y;
                    let _e549 = (ps_r1_.xy + global.ps_uniforms_vec4_[10].xy);
                    ps_r8_.x = _e549.x;
                    ps_r8_.y = _e549.y;
                    let _e562 = (ps_r1_.xy + global.ps_uniforms_vec4_[11].xy);
                    ps_r9_.x = _e562.x;
                    ps_r9_.y = _e562.y;
                    let _e575 = (ps_r1_.xy + global.ps_uniforms_vec4_[12].xy);
                    ps_r1_.x = _e575.x;
                    ps_r1_.y = _e575.y;
    ...
    let _e1077 = (ps_r0_.www * ps_v0_.xyz);
    ps_r1_.x = _e1077.x;
    ps_r1_.y = _e1077.y;
    ps_r1_.z = _e1077.z;
    let _e1096 = ((ps_r0_.xyz * ps_r1_.xyz) + -(global.ps_uniforms_vec4_[2].xyz));
    ps_r0_.x = _e1096.x;
    ps_r0_.y = _e1096.y;
    ps_r0_.z = _e1096.z;
    let _e1114 = ((io_11_0_.xxx * ps_r0_.xyz) + global.ps_uniforms_vec4_[2].xyz);
    ps_oC0_.x = _e1114.x;
    ps_oC0_.y = _e1114.y;
    ps_oC0_.z = _e1114.z;
