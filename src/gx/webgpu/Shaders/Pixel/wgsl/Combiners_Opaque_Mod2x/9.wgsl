...
@fragment fn main(@location(0) ps_v0_: vec4<f32>, @location(1) ps_v1_: vec4<f32>, @location(2) ps_v2_: vec4<f32>, @location(3) ps_v3_: vec4<f32>, @location(4) ps_v4_: vec4<f32>, @location(5) io_5_4_: vec4<f32>, @location(10) io_11_0_: vec4<f32>) -> FragmentOutput {
            ...
            if (10f < ps_v3_.z) {
                {
                    ...
                    ps_r2_.x = _e191.x;
                    ps_r2_.y = _e191.y;
                    let _e204 = (ps_r1_.yz + global.ps_uniforms_vec4_[7].xy);
                    ps_r3_.x = _e204.x;
                    ps_r3_.y = _e204.y;
                    let _e217 = (ps_r1_.yz + global.ps_uniforms_vec4_[9].xy);
                    ps_r4_.x = _e217.x;
                    ps_r4_.y = _e217.y;
                    let _e230 = (ps_r1_.yz + global.ps_uniforms_vec4_[11].xy);
                    ps_r5_.x = _e230.x;
                    ps_r5_.y = _e230.y;
                ...
                {
                    let _e490 = ((io_5_4_.xy * vec2<f32>(0.5f, 0.5f)) + vec2<f32>(0.5f, 0.5f));
                    ps_r1_.y = _e490.x;
                    ps_r1_.z = _e490.y;
                    let _e503 = (ps_r1_.yz + global.ps_uniforms_vec4_[5].xy);
                    ps_r3_.x = _e503.x;
                    ps_r3_.y = _e503.y;
                    let _e516 = (ps_r1_.yz + global.ps_uniforms_vec4_[6].xy);
                    ps_r4_.x = _e516.x;
                    ps_r4_.y = _e516.y;
                    let _e529 = (ps_r1_.yz + global.ps_uniforms_vec4_[7].xy);
                    ps_r5_.x = _e529.x;
                    ps_r5_.y = _e529.y;
                    let _e542 = (ps_r1_.yz + global.ps_uniforms_vec4_[8].xy);
                    ps_r6_.x = _e542.x;
                    ps_r6_.y = _e542.y;
                    let _e555 = (ps_r1_.yz + global.ps_uniforms_vec4_[9].xy);
                    ps_r7_.x = _e555.x;
                    ps_r7_.y = _e555.y;
                    let _e568 = (ps_r1_.yz + global.ps_uniforms_vec4_[10].xy);
                    ps_r8_.x = _e568.x;
                    ps_r8_.y = _e568.y;
                    let _e581 = (ps_r1_.yz + global.ps_uniforms_vec4_[11].xy);
                    ps_r9_.x = _e581.x;
                    ps_r9_.y = _e581.y;
                    let _e594 = (ps_r1_.yz + global.ps_uniforms_vec4_[12].xy);
                    ps_r10_.x = _e594.x;
                    ps_r10_.y = _e594.y;
    ...
    let _e1096 = (ps_r1_.xxx * ps_v0_.xyz);
    ps_r1_.x = _e1096.x;
    ps_r1_.y = _e1096.y;
    ps_r1_.z = _e1096.z;
    let _e1115 = ((ps_r0_.xyz * ps_r1_.xyz) + -(global.ps_uniforms_vec4_[2].xyz));
    ps_r0_.x = _e1115.x;
    ps_r0_.y = _e1115.y;
    ps_r0_.z = _e1115.z;
    let _e1133 = ((io_11_0_.xxx * ps_r0_.xyz) + global.ps_uniforms_vec4_[2].xyz);
    ps_oC0_.x = _e1133.x;
    ps_oC0_.y = _e1133.y;
    ps_oC0_.z = _e1133.z;
    ps_oC0_.w = ps_r0_.w;
