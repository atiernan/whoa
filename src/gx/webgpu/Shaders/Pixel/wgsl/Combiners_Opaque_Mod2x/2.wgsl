...
@fragment fn main(@location(0) ps_v0_: vec4<f32>, @location(1) ps_v1_: vec4<f32>, @location(2) ps_v2_: vec4<f32>, @location(3) ps_v3_: vec4<f32>, @location(4) ps_v4_: vec4<f32>, @location(5) io_5_4_: vec4<f32>, @location(6) io_5_5_: vec4<f32>, @location(7) io_5_6_: vec4<f32>, @location(10) io_11_0_: vec4<f32>) -> FragmentOutput {
    ...
    if (ps_r1_.x != -(ps_r1_.x)) {
        {
            if (10f < ps_v3_.z) {
                {
                    let _e167 = ((io_5_4_.xy * vec2<f32>(0.5f, 0.5f)) + vec2<f32>(0.5f, 0.5f));
                    ps_r1_.x = _e167.x;
                    ps_r1_.y = _e167.y;
                    let _e180 = (ps_r1_.xy + global.ps_uniforms_vec4_[5].xy);
                    ps_r2_.x = _e180.x;
                    ps_r2_.y = _e180.y;
                    let _e193 = (ps_r1_.xy + global.ps_uniforms_vec4_[7].xy);
                    ps_r3_.x = _e193.x;
                    ps_r3_.y = _e193.y;
                    let _e206 = (ps_r1_.xy + global.ps_uniforms_vec4_[9].xy);
                    ps_r4_.x = _e206.x;
                    ps_r4_.y = _e206.y;
                    let _e219 = (ps_r1_.xy + global.ps_uniforms_vec4_[11].xy);
                    ps_r1_.x = _e219.x;
                    ps_r1_.y = _e219.y;
                ...
                {
                    let _e470 = ((io_5_4_.xy * vec2<f32>(0.5f, 0.5f)) + vec2<f32>(0.5f, 0.5f));
                    ps_r1_.y = _e470.x;
                    ps_r1_.z = _e470.y;
                    let _e483 = (ps_r1_.yz + global.ps_uniforms_vec4_[5].xy);
                    ps_r2_.x = _e483.x;
                    ps_r2_.y = _e483.y;
                    let _e496 = (ps_r1_.yz + global.ps_uniforms_vec4_[6].xy);
                    ps_r3_.x = _e496.x;
                    ps_r3_.y = _e496.y;
                    let _e509 = (ps_r1_.yz + global.ps_uniforms_vec4_[7].xy);
                    ps_r4_.x = _e509.x;
                    ps_r4_.y = _e509.y;
                    let _e522 = (ps_r1_.yz + global.ps_uniforms_vec4_[8].xy);
                    ps_r5_.x = _e522.x;
                    ps_r5_.y = _e522.y;
                    let _e535 = (ps_r1_.yz + global.ps_uniforms_vec4_[9].xy);
                    ps_r6_.x = _e535.x;
                    ps_r6_.y = _e535.y;
                    let _e548 = (ps_r1_.yz + global.ps_uniforms_vec4_[10].xy);
                    ps_r7_.x = _e548.x;
                    ps_r7_.y = _e548.y;
                    let _e561 = (ps_r1_.yz + global.ps_uniforms_vec4_[11].xy);
                    ps_r8_.x = _e561.x;
                    ps_r8_.y = _e561.y;
                    let _e574 = (ps_r1_.yz + global.ps_uniforms_vec4_[12].xy);
                    ps_r9_.x = _e574.x;
                    ps_r9_.y = _e574.y;
    ...
    if (ps_r0_.w < 1f) {
        {
            let _e1034 = ((io_5_5_.xy * vec2<f32>(0.5f, 0.5f)) + vec2<f32>(0.5f, 0.5f));
            ps_r1_.x = _e1034.x;
            ps_r1_.y = _e1034.y;
            let _e1047 = (ps_r1_.xy + global.ps_uniforms_vec4_[5].xy);
            ps_r3_.x = _e1047.x;
            ps_r3_.y = _e1047.y;
            let _e1060 = (ps_r1_.xy + global.ps_uniforms_vec4_[7].xy);
            ps_r4_.x = _e1060.x;
            ps_r4_.y = _e1060.y;
            let _e1073 = (ps_r1_.xy + global.ps_uniforms_vec4_[9].xy);
            ps_r5_.x = _e1073.x;
            ps_r5_.y = _e1073.y;
            let _e1086 = (ps_r1_.xy + global.ps_uniforms_vec4_[11].xy);
            ps_r1_.x = _e1086.x;
            ps_r1_.y = _e1086.y;
    ...
    } else {
        {
            ...
            if (ps_r1_.x < 1f) {
                {
                    let _e1335 = ((io_5_6_.xy * vec2<f32>(0.5f, 0.5f)) + vec2<f32>(0.5f, 0.5f));
                    ps_r1_.x = _e1335.x;
                    ps_r1_.y = _e1335.y;
                    let _e1348 = (ps_r1_.xy + global.ps_uniforms_vec4_[5].xy);
                    ps_r3_.x = _e1348.x;
                    ps_r3_.y = _e1348.y;
                    let _e1361 = (ps_r1_.xy + global.ps_uniforms_vec4_[7].xy);
                    ps_r4_.x = _e1361.x;
                    ps_r4_.y = _e1361.y;
                    let _e1374 = (ps_r1_.xy + global.ps_uniforms_vec4_[9].xy);
                    ps_r5_.x = _e1374.x;
                    ps_r5_.y = _e1374.y;
                    let _e1387 = (ps_r1_.xy + global.ps_uniforms_vec4_[11].xy);
                    ps_r1_.x = _e1387.x;
                    ps_r1_.y = _e1387.y;
            ...
            } else {
                {
                    ...
                    let _e1641 = (ps_r1_.xy + global.ps_uniforms_vec4_[5].xy);
                    ps_r3_.x = _e1641.x;
                    ps_r3_.y = _e1641.y;
                    let _e1654 = (ps_r1_.xy + global.ps_uniforms_vec4_[7].xy);
                    ps_r4_.x = _e1654.x;
                    ps_r4_.y = _e1654.y;
                    let _e1667 = (ps_r1_.xy + global.ps_uniforms_vec4_[9].xy);
                    ps_r5_.x = _e1667.x;
                    ps_r5_.y = _e1667.y;
                    let _e1680 = (ps_r1_.xy + global.ps_uniforms_vec4_[11].xy);
                    ps_r6_.x = _e1680.x;
                    ps_r6_.y = _e1680.y;
                    ps_r1_.z = 0f;
                    ps_r1_.w = 0f;
    ...
    let _e2012 = (ps_r0_.www * ps_v0_.xyz);
    ps_r1_.x = _e2012.x;
    ps_r1_.y = _e2012.y;
    ps_r1_.z = _e2012.z;
    let _e2031 = ((ps_r0_.xyz * ps_r1_.xyz) + -(global.ps_uniforms_vec4_[2].xyz));
    ps_r0_.x = _e2031.x;
    ps_r0_.y = _e2031.y;
    ps_r0_.z = _e2031.z;
    let _e2049 = ((io_11_0_.xxx * ps_r0_.xyz) + global.ps_uniforms_vec4_[2].xyz);
    ps_oC0_.x = _e2049.x;
    ps_oC0_.y = _e2049.y;
    ps_oC0_.z = _e2049.z;
