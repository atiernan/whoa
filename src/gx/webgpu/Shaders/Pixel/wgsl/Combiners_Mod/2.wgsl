...
@fragment fn main(@location(0) ps_v0_: vec4<f32>, @location(1) ps_v1_: vec4<f32>, @location(2) ps_v2_: vec4<f32>, @location(3) ps_v3_: vec4<f32>, @location(4) ps_v4_: vec4<f32>, @location(5) io_5_4_: vec4<f32>, @location(6) io_5_5_: vec4<f32>, @location(10) io_11_0_: vec4<f32>) -> FragmentOutput {
            ...
            if (10f < ps_v2_.z) {
                {
                    ...
                    ps_r1_.x = _e129.x;
                    ps_r1_.y = _e129.y;
                    let _e142 = (ps_r1_.xy + global.ps_uniforms_vec4_[5].xy);
                    ps_r2_.x = _e142.x;
                    ps_r2_.y = _e142.y;
                    let _e155 = (ps_r1_.xy + global.ps_uniforms_vec4_[7].xy);
                    ps_r3_.x = _e155.x;
                    ps_r3_.y = _e155.y;
                    let _e168 = (ps_r1_.xy + global.ps_uniforms_vec4_[9].xy);
                    ps_r4_.x = _e168.x;
                    ps_r4_.y = _e168.y;
                    let _e181 = (ps_r1_.xy + global.ps_uniforms_vec4_[11].xy);
                    ps_r1_.x = _e181.x;
                    ps_r1_.y = _e181.y;
                ...
                {
                    let _e434 = ((ps_v4_.xy * vec2<f32>(0.5f, 0.5f)) + vec2<f32>(0.5f, 0.5f));
                    ps_r1_.y = _e434.x;
                    ps_r1_.z = _e434.y;
                    let _e447 = (ps_r1_.yz + global.ps_uniforms_vec4_[5].xy);
                    ps_r2_.x = _e447.x;
                    ps_r2_.y = _e447.y;
                    let _e460 = (ps_r1_.yz + global.ps_uniforms_vec4_[6].xy);
                    ps_r3_.x = _e460.x;
                    ps_r3_.y = _e460.y;
                    let _e473 = (ps_r1_.yz + global.ps_uniforms_vec4_[7].xy);
                    ps_r4_.x = _e473.x;
                    ps_r4_.y = _e473.y;
                    let _e486 = (ps_r1_.yz + global.ps_uniforms_vec4_[8].xy);
                    ps_r5_.x = _e486.x;
                    ps_r5_.y = _e486.y;
                    let _e499 = (ps_r1_.yz + global.ps_uniforms_vec4_[9].xy);
                    ps_r6_.x = _e499.x;
                    ps_r6_.y = _e499.y;
                    let _e512 = (ps_r1_.yz + global.ps_uniforms_vec4_[10].xy);
                    ps_r7_.x = _e512.x;
                    ps_r7_.y = _e512.y;
                    let _e525 = (ps_r1_.yz + global.ps_uniforms_vec4_[11].xy);
                    ps_r8_.x = _e525.x;
                    ps_r8_.y = _e525.y;
                    let _e538 = (ps_r1_.yz + global.ps_uniforms_vec4_[12].xy);
                    ps_r9_.x = _e538.x;
                    ps_r9_.y = _e538.y;
    ...
    if (ps_r0_.w < 1f) {
        {
            let _e998 = ((io_5_4_.xy * vec2<f32>(0.5f, 0.5f)) + vec2<f32>(0.5f, 0.5f));
            ps_r1_.x = _e998.x;
            ps_r1_.y = _e998.y;
            let _e1011 = (ps_r1_.xy + global.ps_uniforms_vec4_[5].xy);
            ps_r3_.x = _e1011.x;
            ps_r3_.y = _e1011.y;
            let _e1024 = (ps_r1_.xy + global.ps_uniforms_vec4_[7].xy);
            ps_r4_.x = _e1024.x;
            ps_r4_.y = _e1024.y;
            let _e1037 = (ps_r1_.xy + global.ps_uniforms_vec4_[9].xy);
            ps_r5_.x = _e1037.x;
            ps_r5_.y = _e1037.y;
            let _e1050 = (ps_r1_.xy + global.ps_uniforms_vec4_[11].xy);
            ps_r1_.x = _e1050.x;
            ps_r1_.y = _e1050.y;
    ...
    } else {
        {
            ...
            if (ps_r1_.x < 1f) {
                {
                    let _e1300 = ((io_5_5_.xy * vec2<f32>(0.5f, 0.5f)) + vec2<f32>(0.5f, 0.5f));
                    ps_r1_.x = _e1300.x;
                    ps_r1_.y = _e1300.y;
                    let _e1313 = (ps_r1_.xy + global.ps_uniforms_vec4_[5].xy);
                    ps_r3_.x = _e1313.x;
                    ps_r3_.y = _e1313.y;
                    let _e1326 = (ps_r1_.xy + global.ps_uniforms_vec4_[7].xy);
                    ps_r4_.x = _e1326.x;
                    ps_r4_.y = _e1326.y;
                    let _e1339 = (ps_r1_.xy + global.ps_uniforms_vec4_[9].xy);
                    ps_r5_.x = _e1339.x;
                    ps_r5_.y = _e1339.y;
                    let _e1352 = (ps_r1_.xy + global.ps_uniforms_vec4_[11].xy);
                    ps_r1_.x = _e1352.x;
                    ps_r1_.y = _e1352.y;
            ...
            } else {
                {
                    ...
                    let _e1607 = (ps_r1_.xy + global.ps_uniforms_vec4_[5].xy);
                    ps_r3_.x = _e1607.x;
                    ps_r3_.y = _e1607.y;
                    let _e1620 = (ps_r1_.xy + global.ps_uniforms_vec4_[7].xy);
                    ps_r4_.x = _e1620.x;
                    ps_r4_.y = _e1620.y;
                    let _e1633 = (ps_r1_.xy + global.ps_uniforms_vec4_[9].xy);
                    ps_r5_.x = _e1633.x;
                    ps_r5_.y = _e1633.y;
                    let _e1646 = (ps_r1_.xy + global.ps_uniforms_vec4_[11].xy);
                    ps_r6_.x = _e1646.x;
                    ps_r6_.y = _e1646.y;
                    ps_r1_.z = 0f;
                    ps_r1_.w = 0f;
    ...
    let _e1980 = (ps_r0_.www * ps_v0_.xyz);
    ps_r1_.x = _e1980.x;
    ps_r1_.y = _e1980.y;
    ps_r1_.z = _e1980.z;
    let _e1999 = ((ps_r0_.xyz * ps_r1_.xyz) + -(global.ps_uniforms_vec4_[2].xyz));
    ps_r0_.x = _e1999.x;
    ps_r0_.y = _e1999.y;
    ps_r0_.z = _e1999.z;
    let _e2017 = ((io_11_0_.xxx * ps_r0_.xyz) + global.ps_uniforms_vec4_[2].xyz);
    ps_oC0_.x = _e2017.x;
    ps_oC0_.y = _e2017.y;
    ps_oC0_.z = _e2017.z;
