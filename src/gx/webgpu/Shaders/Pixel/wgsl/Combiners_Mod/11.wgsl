...
@fragment fn main(@location(0) ps_v0_: vec4<f32>, @location(1) ps_v1_: vec4<f32>, @location(2) ps_v2_: vec4<f32>, @location(3) ps_v3_: vec4<f32>, @location(4) ps_v4_: vec4<f32>, @location(5) io_5_4_: vec4<f32>, @location(6) io_5_5_: vec4<f32>, @location(10) io_11_0_: vec4<f32>) -> FragmentOutput {
    ...
    if (ps_r0_.w != -(ps_r0_.w)) {
        {
            if (10f < ps_v2_.z) {
                {
                    let _e134 = ((ps_v4_.xy * vec2<f32>(0.5f, 0.5f)) + vec2<f32>(0.5f, 0.5f));
                    ps_r1_.y = _e134.x;
                    ps_r1_.z = _e134.y;
                    let _e147 = (ps_r1_.yz + global.ps_uniforms_vec4_[5].xy);
                    ps_r2_.x = _e147.x;
                    ps_r2_.y = _e147.y;
                    let _e160 = (ps_r1_.yz + global.ps_uniforms_vec4_[7].xy);
                    ps_r3_.x = _e160.x;
                    ps_r3_.y = _e160.y;
                    let _e173 = (ps_r1_.yz + global.ps_uniforms_vec4_[9].xy);
                    ps_r4_.x = _e173.x;
                    ps_r4_.y = _e173.y;
                    let _e186 = (ps_r1_.yz + global.ps_uniforms_vec4_[11].xy);
                    ps_r5_.x = _e186.x;
                    ps_r5_.y = _e186.y;
                ...
                {
                    let _e419 = ((ps_v4_.xy * vec2<f32>(0.5f, 0.5f)) + vec2<f32>(0.5f, 0.5f));
                    ps_r1_.y = _e419.x;
                    ps_r1_.z = _e419.y;
                    let _e432 = (ps_r1_.yz + global.ps_uniforms_vec4_[5].xy);
                    ps_r2_.x = _e432.x;
                    ps_r2_.y = _e432.y;
                    let _e445 = (ps_r1_.yz + global.ps_uniforms_vec4_[7].xy);
                    ps_r3_.x = _e445.x;
                    ps_r3_.y = _e445.y;
                    let _e458 = (ps_r1_.yz + global.ps_uniforms_vec4_[9].xy);
                    ps_r4_.x = _e458.x;
                    ps_r4_.y = _e458.y;
                    let _e471 = (ps_r1_.yz + global.ps_uniforms_vec4_[11].xy);
                    ps_r5_.x = _e471.x;
                    ps_r5_.y = _e471.y;
                    ps_r6_ = ((ps_v4_.xyxx * vec4<f32>(0.5f, 0.5f, 0f, 0f)) + vec4<f32>(0.5f, 0.5f, 0f, 0f));
                    ps_r6_ = textureSampleLevel(ps_s4_tex, ps_s4_smp, ps_r6_.xy, ps_r6_.w);
    ...
    if (ps_r0_.w < 1f) {
        {
            let _e756 = ((io_5_4_.xy * vec2<f32>(0.5f, 0.5f)) + vec2<f32>(0.5f, 0.5f));
            ps_r1_.y = _e756.x;
            ps_r1_.z = _e756.y;
            let _e769 = (ps_r1_.yz + global.ps_uniforms_vec4_[5].xy);
            ps_r3_.x = _e769.x;
            ps_r3_.y = _e769.y;
            let _e782 = (ps_r1_.yz + global.ps_uniforms_vec4_[7].xy);
            ps_r4_.x = _e782.x;
            ps_r4_.y = _e782.y;
            let _e795 = (ps_r1_.yz + global.ps_uniforms_vec4_[9].xy);
            ps_r5_.x = _e795.x;
            ps_r5_.y = _e795.y;
            let _e808 = (ps_r1_.yz + global.ps_uniforms_vec4_[11].xy);
            ps_r6_.x = _e808.x;
            ps_r6_.y = _e808.y;
    ...
    } else {
        {
            ...
            if (ps_r1_.y < 1f) {
                {
                    let _e1057 = ((io_5_5_.xy * vec2<f32>(0.5f, 0.5f)) + vec2<f32>(0.5f, 0.5f));
                    ps_r1_.y = _e1057.x;
                    ps_r1_.z = _e1057.y;
                    let _e1070 = (ps_r1_.yz + global.ps_uniforms_vec4_[5].xy);
                    ps_r3_.x = _e1070.x;
                    ps_r3_.y = _e1070.y;
                    let _e1083 = (ps_r1_.yz + global.ps_uniforms_vec4_[7].xy);
                    ps_r4_.x = _e1083.x;
                    ps_r4_.y = _e1083.y;
                    let _e1096 = (ps_r1_.yz + global.ps_uniforms_vec4_[9].xy);
                    ps_r5_.x = _e1096.x;
                    ps_r5_.y = _e1096.y;
                    let _e1109 = (ps_r1_.yz + global.ps_uniforms_vec4_[11].xy);
                    ps_r6_.x = _e1109.x;
                    ps_r6_.y = _e1109.y;
            ...
            } else {
                {
                    ...
                    let _e1363 = (ps_r3_.xy + global.ps_uniforms_vec4_[5].xy);
                    ps_r4_.x = _e1363.x;
                    ps_r4_.y = _e1363.y;
                    let _e1376 = (ps_r3_.xy + global.ps_uniforms_vec4_[7].xy);
                    ps_r5_.x = _e1376.x;
                    ps_r5_.y = _e1376.y;
                    let _e1389 = (ps_r3_.xy + global.ps_uniforms_vec4_[9].xy);
                    ps_r6_.x = _e1389.x;
                    ps_r6_.y = _e1389.y;
                    let _e1402 = (ps_r3_.xy + global.ps_uniforms_vec4_[11].xy);
                    ps_r7_.x = _e1402.x;
                    ps_r7_.y = _e1402.y;
                    ps_r3_.z = 0f;
                    ps_r3_.w = 0f;
    ...
    let _e1734 = (ps_r0_.www * ps_v0_.xyz);
    ps_r1_.y = _e1734.x;
    ps_r1_.z = _e1734.y;
    ps_r1_.w = _e1734.z;
    let _e1753 = ((ps_r0_.xyz * ps_r1_.yzw) + -(global.ps_uniforms_vec4_[2].xyz));
    ps_r0_.x = _e1753.x;
    ps_r0_.y = _e1753.y;
    ps_r0_.z = _e1753.z;
    let _e1771 = ((io_11_0_.xxx * ps_r0_.xyz) + global.ps_uniforms_vec4_[2].xyz);
    ps_oC0_.x = _e1771.x;
    ps_oC0_.y = _e1771.y;
    ps_oC0_.z = _e1771.z;
    ps_oC0_.w = ps_r1_.x;
